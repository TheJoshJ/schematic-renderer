import { Scene as $e, OrthographicCamera as Vt, Mesh as Yt, BasicDepthPacking as F, WebGLRenderTarget as y, Material as Mt, Texture as ke, ShaderMaterial as U, Uniform as c, NoBlending as R, AlwaysDepth as It, LinearFilter as X, UnsignedByteType as H, SRGBColorSpace as w, Vector2 as g, DepthTexture as Pt, DepthStencilFormat as Wt, UnsignedInt248Type as Xt, UnsignedIntType as Kt, LinearSRGBColorSpace as ze, BackSide as Ue, DoubleSide as Re, FrontSide as Zt, EventDispatcher as nt, CanvasTexture as jt, RepeatWrapping as Be, NoColorSpace as yt, Vector4 as oe, Color as K, REVISION as Me, PerspectiveCamera as pe, DataTexture as Ut, RedFormat as Rt, RGBAFormat as ae, NearestFilter as _, Vector3 as z, FloatType as Y, HalfFloatType as bt, Data3DTexture as He, ClampToEdgeWrapping as Ye, RGBADepthPacking as q, MeshDepthMaterial as Jt, LessDepth as ut, EqualDepth as et, NotEqualDepth as Lt, LoadingManager as le, Matrix4 as tt, LinearMipmapLinearFilter as qt, Loader as ot, FileLoader as Ft, MeshNormalMaterial as $t, BufferGeometry as er, BufferAttribute as ft, GreaterDepth as tr, GreaterEqualDepth as rr, LessEqualDepth as ir, NeverDepth as sr, RGFormat as ar } from "three";
/**
 ...
 * @license Zlib
 */
var fa = "6.38.2", ha = class {
  /**
   * Frees internal resources.
   */
  dispose() {
  }
}, We = 1 / 1e3, nr = 1e3, or = class {
  /**
  ...
  const e = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]), t = new Float32Array([0, 0, 2, 0, 0, 2]), r = new er();
  return r.setAttribute("position", new ft(e, 3)), r.setAttribute("uv", new ft(t, 2)), r;
})(), O = class rt {
  /**
   ...
   */
  constructor(t = "Pass", r = new $e(), i = new Vt()) {
    this.name = t, this.renderer = null, this.scene = r, this.camera = i, this.screen = null, this.rtt = true, this.needsSwap = true, this.needsDepthTexture = false, this.enabled = true;
  }
  /**
  ...
  set fullscreenMaterial(t) {
    let r = this.screen;
    r !== null ? r.material = t : (r = new Yt(rt.fullscreenGeometry, t), r.frustumCulled = false, this.scene === null && (this.scene = new $e()), this.scene.add(r), this.screen = r);
  }
  /**
  ...
  dispose() {
    for (const t of Object.keys(this)) {
      const r = this[t];
      (r instanceof y || r instanceof Mt || r instanceof ke || r instanceof rt) && this[t].dispose();
    }
...
gl_FragDepth=readDepth(vUv);
  ...
  constructor(e, t = true) {
    super("CopyPass"), this.fullscreenMaterial = new _e(), this.needsSwap = false, this.renderTarget = e, e === void 0 && (this.renderTarget = new y(1, 1, {
      minFilter: X,
      magFilter: X,
      stencilBuffer: false,
      depthBuffer: false
   ...
   */
  initialize(e, t, r) {
    r !== void 0 && (this.renderTarget.texture.type = r, r !== H ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === w && (this.renderTarget.texture.colorSpace = w));
  }
}, ht = /* @__PURE__ */ new K(), Ie = class extends O {
  /**
   ...
   */
  constructor(e = true, t = true, r = false) {
    super("ClearPass", null, null), this.needsSwap = false, this.color = e, this.depth = t, this.stencil = r, this.overrideClearColor = null, this.overrideClearAlpha = -1;
  }
  /**
  ...
  render(e, t, r, i, s) {
    ...
    l ? (e.getClearColor(ht), e.setClearColor(a, u ? n : o)) : u && e.setClearAlpha(n), e.setRenderTarget(this.renderToScreen ? null : t), e.clear(this.color, this.depth, this.stencil), l ? e.setClearColor(ht, o) : u && e.setClearAlpha(o);
  }
}, fr = class extends O {
  /**
   ...
   */
  constructor(e, t) {
    super("MaskPass", e, t), this.needsSwap = false, this.clearPass = new Ie(false, false, true), this.inverse = false;
  }
  set mainScene(e) {
    this.scene = e;
  }
   ...
   */
  render(e, t, r, i, s) {
    const a = e.getContext(), n = e.state.buffers, o = this.scene, l = this.camera, u = this.clearPass, h = this.inverted ? 0 : 1, f = 1 - h;
    n.color.setMask(false), n.depth.setMask(false), n.color.setLocked(true), n.depth.setLocked(true), n.stencil.setTest(true), n.stencil.setOp(a.REPLACE, a.REPLACE, a.REPLACE), n.stencil.setFunc(a.ALWAYS, h, 4294967295), n.stencil.setClear(f), n.stencil.setLocked(true), this.clearPass.enabled && (this.renderToScreen ? u.render(e, null) : (u.render(e, t), u.render(e, r))), this.renderToScreen ? (e.setRenderTarget(null), e.render(o, l)) : (e.setRenderTarget(t), e.render(o, l), e.setRenderTarget(r), e.render(o, l)), n.color.setLocked(false), n.depth.setLocked(false), n.stencil.setLocked(false), n.stencil.setFunc(a.EQUAL, 1, 4294967295), n.stencil.setOp(a.KEEP, a.KEEP, a.KEEP), n.stencil.setLocked(true);
  }
}, da = class {
  /**
  ...
  constructor(e = null, {
    depthBuffer: t = true,
    stencilBuffer: r = false,
    multisampling: i = 0,
    frameBufferType: s
  } = {}) {
    this.renderer = null, this.inputBuffer = this.createBuffer(t, r, s, i), this.outputBuffer = this.inputBuffer.clone(), this.copyPass = new lt(), this.depthTexture = null, this.passes = [], this.timer = new or(), this.autoRenderToScreen = true, this.setRenderer(e);
  }
  /**
  ...
  set multisampling(e) {
    ...
    r > 0 && e > 0 ? (this.inputBuffer.samples = e, this.outputBuffer.samples = e, this.inputBuffer.dispose(), this.outputBuffer.dispose()) : r !== e && (this.inputBuffer.dispose(), this.outputBuffer.dispose(), this.inputBuffer = this.createBuffer(
      t.depthBuffer,
      t.stencilBuffer,
      t.texture.type,
      e
  ...
  setRenderer(e) {
    if (this.renderer = e, e !== null) {
      const t = e.getSize(new g()), r = e.getContext().getContextAttributes().alpha, i = this.inputBuffer.texture.type;
      i === H && e.outputColorSpace === w && (this.inputBuffer.texture.colorSpace = w, this.outputBuffer.texture.colorSpace = w, this.inputBuffer.dispose(), this.outputBuffer.dispose()), e.autoClear = false, this.setSize(t.width, t.height);
  ...
  replaceRenderer(e, t = true) {
    ...
    return this.setRenderer(e), t && i !== null && (i.removeChild(r.domElement), i.appendChild(e.domElement)), r;
  }
  /**
   ...
   */
  createDepthTexture() {
    const e = this.depthTexture = new Pt();
  ...
  createBuffer(e, t, r, i) {
    const s = this.renderer, a = s === null ? new g() : s.getDrawingBufferSize(new g()), n = {
      ...
      depthBuffer: e,
      type: r
    }, o = new y(a.width, a.height, n);
    return i > 0 && (o.samples = i), r === H && s !== null && s.outputColorSpace === w && (o.texture.colorSpace = w), o.texture.name = "EffectComposer.Buffer", o.texture.generateMipmaps = false, o;
  }
  /**
   ...
   */
  addPass(e, t) {
    const r = this.passes, i = this.renderer, s = i.getDrawingBufferSize(new g()), a = i.getContext().getContextAttributes().alpha, n = this.inputBuffer.texture.type;
    if (e.setRenderer(i), e.setSize(s.width, s.height), e.initialize(i, a, n), this.autoRenderToScreen && (r.length > 0 && (r[r.length - 1].renderToScreen = false), e.renderToScreen && (this.autoRenderToScreen = false)), t !== void 0 ? r.splice(t, 0, e) : r.push(e), this.autoRenderToScreen && (r[r.length - 1].renderToScreen = true), e.needsDepthTexture || this.depthTexture !== null)
      if (this.depthTexture === null) {
   ...
   */
  removePass(e) {
    const t = this.passes, r = t.indexOf(e);
    if (r !== -1 && t.splice(r, 1).length > 0) {
      ...
      this.autoRenderToScreen && r === t.length && (e.renderToScreen = false, t.length > 0 && (t[t.length - 1].renderToScreen = true));
    }
  }
  /**
   * Removes all passes.
  ...
  render(e) {
    ...
    let i = this.inputBuffer, s = this.outputBuffer, a = false, n, o, l;
    e === void 0 && (this.timer.update(), e = this.timer.getDelta());
    for (const u of this.passes)
      u.enabled && (u.render(t, i, s, e, a), u.needsSwap && (a && (r.renderToScreen = u.renderToScreen, n = t.getContext(), o = t.state.buffers.stencil, o.setFunc(n.NOTEQUAL, 1, 4294967295), r.render(t, i, s, e, a), o.setFunc(n.EQUAL, 1, 4294967295)), l = i, i = s, s = l), u instanceof fr ? a = true : u instanceof cr && (a = false));
  }
  /**
   ...
   */
  setSize(e, t, r) {
    const i = this.renderer, s = i.getSize(new g());
    (e === void 0 || t === void 0) && (e = s.width, t = s.height), (s.width !== e || s.height !== t) && i.setSize(e, t, r);
    const a = i.getDrawingBufferSize(new g());
...
function dt(e) {
  ...
  if (e === 0)
    ...
    let r = new Float64Array(e), i = new Float64Array(e);
    for (let s = 1; s <= e; ++s) {
      for (let a = 0; a < s; ++a)
        i[a] = a === 0 || a === s - 1 ? 1 : r[a - 1] + r[a];
      t = i, i = r, r = t;
    }
  }
  return t;
...
var dr = class {
  ...
  generate(e, t) {
    ...
    const r = e + t * 2, i = t > 0 ? dt(r).slice(t, -t) : dt(r), s = Math.floor((i.length - 1) / 2), a = i.reduce((f, d) => f + d, 0), n = i.slice(s), o = [...Array(s + 1).keys()], l = new Float64Array(Math.floor(o.length / 2)), u = new Float64Array(l.length);
    l[0] = n[0] / a;
    for (let f = 1, d = 1, v = o.length - 1; f < v; f += 2, ++d) {
      const A = o[f], p = o[f + 1], x = n[f], C = n[f + 1], T = x + C, D = (A * x + p * C) / T;
      l[d] = T / a, u[d] = D;
    }
    for (let f = 0, d = n.length, v = 1 / a; f < d; ++f)
      n[f] *= v;
    const h = (l.reduce((f, d) => f + d, 0) - l[0] * 0.5) * 2;
    if (h !== 0)
      for (let f = 0, d = l.length, v = 1 / h; f < d; ++f)
        l[f] *= v;
  ...
  cloneMaterial(e) {
    if (!(e instanceof U))
      return e.clone();
    const t = e.uniforms, r = /* @__PURE__ */ new Map();
    for (const s in t) {
      const a = t[s].value;
      a.isRenderTargetTexture && (t[s].value = null, r.set(s, a));
    }
    const i = e.clone();
    for (const s of r)
      t[s[0]].value = s[1], i.uniforms[s[0]].value = s[1];
    return i;
  }
  /**
  ...
  setMaterial(e) {
    if (this.disposeMaterials(), this.material = e, e !== null) {
      ...
      for (const r of t)
        r.uniforms = Object.assign({}, e.uniforms), r.side = Zt;
      t[2].skinning = true, this.materialsBackSide = t.map((r) => {
        const i = this.cloneMaterial(r);
        return i.uniforms = Object.assign({}, e.uniforms), i.side = Ue, i;
      }), this.materialsDoubleSide = t.map((r) => {
        const i = this.cloneMaterial(r);
        return i.uniforms = Object.assign({}, e.uniforms), i.side = Re, i;
        ...
        const i = this.cloneMaterial(r);
        return i.uniforms = Object.assign({}, e.uniforms), i.flatShading = true, i.side = Ue, i;
      }), this.materialsFlatShadedDoubleSide = t.map((r) => {
        const i = this.cloneMaterial(r);
        return i.uniforms = Object.assign({}, e.uniforms), i.flatShading = true, i.side = Re, i;
      });
    }
  }
  /**
  ...
  render(e, t, r) {
    ...
    if (e.shadowMap.enabled = false, Xe) {
      ...
      this.meshCount = 0, t.traverse(this.replaceMaterial), e.render(t, r);
      for (const a of s)
        a[0].material = a[1];
   ...
   */
  constructor(e, t = te, r = te, i = 1) {
    super(), this.resizable = e, this.baseSize = new g(1, 1), this.preferredSize = new g(t, r), this.target = this.preferredSize, this.s = i, this.effectiveSize = new g(), this.addEventListener("change", () => this.updateEffectiveSize()), this.updateEffectiveSize();
  }
  /**
   ...
   */
  updateEffectiveSize() {
    const e = this.baseSize, t = this.preferredSize, r = this.effectiveSize, i = this.scale;
    t.width !== te ? r.width = t.width : t.height !== te ? r.width = Math.round(t.height * (e.width / Math.max(e.height, 1))) : r.width = Math.round(e.width * i), t.height !== te ? r.height = t.height : t.width !== te ? r.height = Math.round(t.width / Math.max(e.width / Math.max(e.height, 1), 1)) : r.height = Math.round(e.height * i);
  }
  /**
   * The effective width.
   *
...
}, Ke = /* @__PURE__ */ new vr(2), Ot = class extends Set {
  /**
  ...
  set layer(e) {
    const t = this._layer;
    for (const r of this)
      r.layers.disable(t), r.layers.enable(e);
    this._layer = e;
  }
  /**
  ...
  SUBTRACT: 31,
  VIVID_LIGHT: 32
}, gr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=dst.rgb+src.rgb;return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", pr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){return mix(dst,src,src.a*opacity);}", mr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=(dst.rgb+src.rgb)*0.5;return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Ar = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=RGBToHSL(dst.rgb);vec3 b=RGBToHSL(src.rgb);vec3 c=HSLToRGB(vec3(b.xy,a.z));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", xr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=dst.rgb,b=src.rgb;vec3 c=mix(step(0.0,b)*(1.0-min(vec3(1.0),(1.0-a)/max(b,1e-9))),vec3(1.0),step(1.0,a));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Er = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=dst.rgb,b=src.rgb;vec3 c=step(0.0,a)*mix(min(vec3(1.0),a/max(1.0-b,1e-9)),vec3(1.0),step(1.0,b));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Dr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=min(dst.rgb,src.rgb);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", wr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=abs(dst.rgb-src.rgb);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Tr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=dst.rgb/max(src.rgb,1e-9);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Cr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=dst.rgb+src.rgb-2.0*dst.rgb*src.rgb;return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Sr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=min(dst.rgb,1.0);vec3 b=min(src.rgb,1.0);vec3 c=mix(2.0*a*b,1.0-2.0*(1.0-a)*(1.0-b),step(0.5,b));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Br = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=step(1.0,dst.rgb+src.rgb);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Mr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=RGBToHSL(dst.rgb);vec3 b=RGBToHSL(src.rgb);vec3 c=HSLToRGB(vec3(b.x,a.yz));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Ir = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=max(1.0-src.rgb,0.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Pr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=src.rgb*max(1.0-dst.rgb,0.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", yr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=max(dst.rgb,src.rgb);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Ur = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=clamp(src.rgb+dst.rgb-1.0,0.0,1.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Rr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=min(dst.rgb+src.rgb,1.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", br = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=clamp(2.0*src.rgb+dst.rgb-1.0,0.0,1.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Lr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=RGBToHSL(dst.rgb);vec3 b=RGBToHSL(src.rgb);vec3 c=HSLToRGB(vec3(a.xy,b.z));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Fr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=dst.rgb*src.rgb;return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Or = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=max(1.0-abs(1.0-dst.rgb-src.rgb),0.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Nr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){return mix(dst,src,opacity);}", Hr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=2.0*src.rgb*dst.rgb;vec3 b=1.0-2.0*(1.0-src.rgb)*(1.0-dst.rgb);vec3 c=mix(a,b,step(0.5,dst.rgb));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Gr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 src2=2.0*src.rgb;vec3 c=mix(mix(src2,dst.rgb,step(0.5*dst.rgb,src.rgb)),max(src2-1.0,vec3(0.0)),step(dst.rgb,src2-1.0));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", kr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=min(dst.rgb*dst.rgb/max(1.0-src.rgb,1e-9),1.0);vec3 c=mix(a,src.rgb,step(1.0,src.rgb));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", zr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 a=RGBToHSL(dst.rgb);vec3 b=RGBToHSL(src.rgb);vec3 c=HSLToRGB(vec3(a.x,b.y,a.z));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", _r = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=dst.rgb+src.rgb-min(dst.rgb*src.rgb,1.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Qr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 src2=2.0*src.rgb;vec3 d=dst.rgb+(src2-1.0);vec3 w=step(0.5,src.rgb);vec3 a=dst.rgb-(1.0-src2)*dst.rgb*(1.0-dst.rgb);vec3 b=mix(d*(sqrt(dst.rgb)-dst.rgb),d*dst.rgb*((16.0*dst.rgb-12.0)*dst.rgb+3.0),w*(1.0-step(0.25,dst.rgb)));vec3 c=mix(a,b,w);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Vr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){return src;}", Yr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=max(dst.rgb-src.rgb,0.0);return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Wr = "vec4 blend(const in vec4 dst,const in vec4 src,const in float opacity){vec3 c=mix(max(1.0-min((1.0-dst.rgb)/(2.0*src.rgb),1.0),0.0),min(dst.rgb/(2.0*(1.0-src.rgb)),1.0),step(0.5,src.rgb));return mix(dst,vec4(c,max(dst.a,src.a)),opacity);}", Xr = /* @__PURE__ */ new Map([
  [m.ADD, gr],
  [m.ALPHA, pr],
  [m.AVERAGE, mr],
  [m.COLOR, Ar],
   ...
   */
  getShaderCode() {
    return Xr.get(this.blendFunction);
  }
}, Zr = class extends jt {
  /**
  ...
  constructor({
    ...
    const a = this.image;
    a.width = a.height = i;
    const n = a.getContext("2d"), o = i / s;
    n.font = `${r}px ${t}`, n.textAlign = "center", n.textBaseline = "middle", n.fillStyle = "#ffffff";
    for (let l = 0, u = e.length; l < u; ++l) {
      const h = e[l], f = l % s, d = Math.floor(l / s);
      n.fillText(h, f * o + o / 2, d * o + o / 2);
    }
  ...
  constructor(e, t, {
    attributes: r = N.NONE,
    blendFunction: i = m.NORMAL,
    defines: s = /* @__PURE__ */ new Map(),
    uniforms: a = /* @__PURE__ */ new Map(),
    extensions: n = null,
    vertexShader: o = null
  } = {}) {
    super(), this.name = e, this.renderer = null, this.attributes = r, this.fragmentShader = t, this.vertexShader = o, this.defines = s, this.uniforms = a, this.extensions = n, this.blendMode = new Kr(i), this.blendMode.addEventListener("change", (l) => this.setChanged()), this._inputColorSpace = ze, this._outputColorSpace = yt;
  }
  /**
  ...
  dispose() {
    for (const e of Object.keys(this)) {
      const t = this[e];
      (t instanceof y || t instanceof Mt || t instanceof ke || t instanceof O) && this[e].dispose();
    }
  }
}, jr = `uniform sampler2D asciiTexture;uniform vec4 cellCount;
#ifdef USE_COLOR
uniform vec3 color;
#endif
...
outputColor=vec4(texel.rgb*asciiCharacter,inputColor.a);
   ...
   */
  constructor({
    asciiTexture: e = new Zr(),
    cellSize: t = 16,
    color: r = null,
    inverted: i = false
  } = {}) {
    super("ASCIIEffect", jr, {
      uniforms: /* @__PURE__ */ new Map([
        ["asciiTexture", new c(null)],
        ["cellCount", new c(new oe())],
        ["color", new c(new K())]
      ])
    }), this._cellSize = -1, this.resolution = new g(), this.asciiTexture = e, this.cellSize = t, this.color = r, this.inverted = i;
  }
  /**
  ...
  set asciiTexture(e) {
    ...
    if (this.uniforms.get("asciiTexture").value = e, t !== null && t !== e && t.dispose(), e !== null) {
      const r = e.cellCount;
      this.defines.set("CHAR_COUNT_MINUS_ONE", (e.characterCount - 1).toFixed(1)), this.defines.set("TEX_CELL_COUNT", r.toFixed(1)), this.defines.set("INV_TEX_CELL_COUNT", (1 / r).toFixed(9)), this.setChanged();
    }
  }
  /**
...
#include <colorspace_fragment>
  ...
  constructor({
    ...
    super("KawaseBlurPass"), this.renderTargetA = new y(1, 1, { depthBuffer: false }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "Blur.Target.B";
    const n = this.resolution = new E(this, s, a, t);
    n.addEventListener("change", (o) => this.setSize(n.baseWidth, n.baseHeight)), this._blurMaterial = new Nt(), this._blurMaterial.kernelSize = e, this.copyMaterial = new _e();
  }
  /**
   ...
   */
  render(e, t, r, i, s) {
    const a = this.scene, n = this.camera, o = this.renderTargetA, l = this.renderTargetB, u = this.blurMaterial, h = u.kernelSequence;
    let f = t;
    this.fullscreenMaterial = u;
    for (let d = 0, v = h.length; d < v; ++d) {
      const A = d & 1 ? l : o;
      u.kernel = h[d], u.inputBuffer = f.texture, e.setRenderTarget(A), e.render(a, n), f = A;
    }
    this.fullscreenMaterial = this.copyMaterial, this.copyMaterial.inputBuffer = f.texture, e.setRenderTarget(this.renderToScreen ? null : r), e.render(a, n);
  }
  /**
   * Updates the size of this pass.
   *
   ...
   */
  initialize(e, t, r) {
    r !== void 0 && (this.renderTargetA.texture.type = r, this.renderTargetB.texture.type = r, r !== H ? (this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1", this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1") : e !== null && e.outputColorSpace === w && (this.renderTargetA.texture.colorSpace = w, this.renderTargetB.texture.colorSpace = w));
  }
  /**
   * An auto sizing flag.
   *
...
gl_FragColor=vec4(l*mask);
  ...
  constructor({
    ...
    super("LuminancePass"), this.fullscreenMaterial = new ti(r, t), this.needsSwap = false, this.renderTarget = e, this.renderTarget === void 0 && (this.renderTarget = new y(1, 1, { depthBuffer: false }), this.renderTarget.texture.name = "LuminancePass.Target");
    const l = this.resolution = new E(this, n, o, i);
   ...
   */
  initialize(e, t, r) {
    r !== void 0 && r !== H && (this.renderTarget.texture.type = r, this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
}, ri = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, ii = "uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv00;varying vec2 vUv01;varying vec2 vUv02;varying vec2 vUv03;varying vec2 vUv04;varying vec2 vUv05;varying vec2 vUv06;varying vec2 vUv07;varying vec2 vUv08;varying vec2 vUv09;varying vec2 vUv10;varying vec2 vUv11;void main(){vUv=position.xy*0.5+0.5;vUv00=vUv+texelSize*vec2(-1.0,1.0);vUv01=vUv+texelSize*vec2(1.0,1.0);vUv02=vUv+texelSize*vec2(-1.0,-1.0);vUv03=vUv+texelSize*vec2(1.0,-1.0);vUv04=vUv+texelSize*vec2(-2.0,2.0);vUv05=vUv+texelSize*vec2(0.0,2.0);vUv06=vUv+texelSize*vec2(2.0,2.0);vUv07=vUv+texelSize*vec2(-2.0,0.0);vUv08=vUv+texelSize*vec2(2.0,0.0);vUv09=vUv+texelSize*vec2(-2.0,-2.0);vUv10=vUv+texelSize*vec2(0.0,-2.0);vUv11=vUv+texelSize*vec2(2.0,-2.0);gl_Position=vec4(position.xy,1.0,1.0);}", si = class extends U {
  /**
...
}, ai = `#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#include <colorspace_fragment>
}`, ni = "uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;varying vec2 vUv6;varying vec2 vUv7;void main(){vUv=position.xy*0.5+0.5;vUv0=vUv+texelSize*vec2(-1.0,1.0);vUv1=vUv+texelSize*vec2(0.0,1.0);vUv2=vUv+texelSize*vec2(1.0,1.0);vUv3=vUv+texelSize*vec2(-1.0,0.0);vUv4=vUv+texelSize*vec2(1.0,0.0);vUv5=vUv+texelSize*vec2(-1.0,-1.0);vUv6=vUv+texelSize*vec2(0.0,-1.0);vUv7=vUv+texelSize*vec2(1.0,-1.0);gl_Position=vec4(position.xy,1.0,1.0);}", oi = class extends U {
  /**
   ...
   */
  constructor() {
    super("MipmapBlurPass"), this.needsSwap = false, this.renderTarget = new y(1, 1, { depthBuffer: false }), this.renderTarget.texture.name = "Upsampling.Mipmap0", this.downsamplingMipmaps = [], this.upsamplingMipmaps = [], this.downsamplingMaterial = new si(), this.upsamplingMaterial = new oi(), this.resolution = new g();
  }
  /**
  ...
  set levels(e) {
    if (this.levels !== e) {
      ...
      for (let r = 1, i = e - 1; r < i; ++r) {
        const s = t.clone();
        s.texture.name = "Upsampling.Mipmap" + r, this.upsamplingMipmaps.push(s);
      }
   ...
   */
  render(e, t, r, i, s) {
    const { scene: a, camera: n } = this, { downsamplingMaterial: o, upsamplingMaterial: l } = this, { downsamplingMipmaps: u, upsamplingMipmaps: h } = this;
    let f = t;
    this.fullscreenMaterial = o;
    for (let d = 0, v = u.length; d < v; ++d) {
      const A = u[d];
      o.setSize(f.width, f.height), o.inputBuffer = f.texture, e.setRenderTarget(A), e.render(a, n), f = A;
    }
    this.fullscreenMaterial = l;
    for (let d = h.length - 1; d >= 0; --d) {
      const v = h[d];
      l.setSize(f.width, f.height), l.inputBuffer = f.texture, l.supportBuffer = u[d].texture, e.setRenderTarget(v), e.render(a, n), f = v;
    }
  }
  /**
   * Updates the size of this pass.
  ...
  setSize(e, t) {
    const r = this.resolution;
    r.set(e, t);
    let i = r.width, s = r.height;
    for (let a = 0, n = this.downsamplingMipmaps.length; a < n; ++a)
      i = Math.round(i * 0.5), s = Math.round(s * 0.5), this.downsamplingMipmaps[a].setSize(i, s), a < this.upsamplingMipmaps.length && this.upsamplingMipmaps[a].setSize(i, s);
  }
  /**
   * Performs initialization tasks.
   *
  ...
  initialize(e, t, r) {
    if (r !== void 0) {
      ...
      else if (e !== null && e.outputColorSpace === w)
        for (const s of i)
          s.texture.colorSpace = w;
    }
  }
  /**
   * Deletes internal render targets and textures.
...
}, ci = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv)*intensity;}`, ui = class extends B {
  /**
  ...
  constructor({
    ...
    width: u = E.AUTO_SIZE,
    height: h = E.AUTO_SIZE,
    resolutionX: f = u,
    resolutionY: d = h
  } = {}) {
    super("BloomEffect", ci, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["map", new c(null)],
        ["intensity", new c(s)]
      ])
    }), this.renderTarget = new y(1, 1, { depthBuffer: false }), this.renderTarget.texture.name = "Bloom.Target", this.blurPass = new Pe({ kernelSize: o }), this.luminancePass = new Ht({ colorOutput: true }), this.luminanceMaterial.threshold = t, this.luminanceMaterial.smoothing = r, this.mipmapBlurPass = new li(), this.mipmapBlurPass.enabled = i, this.mipmapBlurPass.radius = a, this.mipmapBlurPass.levels = n, this.uniforms.get("map").value = i ? this.mipmapBlurPass.texture : this.renderTarget.texture;
    const v = this.resolution = new E(this, f, d, l);
  ...
  setSize(e, t) {
    const r = this.resolution;
    r.setBaseSize(e, t), this.renderTarget.setSize(r.width, r.height), this.blurPass.resolution.copy(r), this.luminancePass.setSize(e, t), this.mipmapBlurPass.setSize(e, t);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, r) {
    this.blurPass.initialize(e, t, r), this.luminancePass.initialize(e, t, r), this.mipmapBlurPass.initialize(e, t, r), r !== void 0 && (this.renderTarget.texture.type = r, e !== null && e.outputColorSpace === w && (this.renderTarget.texture.colorSpace = w));
  }
}, fi = `uniform float focus;uniform float dof;uniform float aperture;uniform float maxBlur;void mainImage(const in vec4 inputColor,const in vec2 uv,const in float depth,out vec4 outputColor){vec2 aspectCorrection=vec2(1.0,aspect);
#ifdef PERSPECTIVE_CAMERA
float viewZ=perspectiveDepthToViewZ(depth,cameraNear,cameraFar);float linearDepth=viewZToOrthographicDepth(viewZ,cameraNear,cameraFar);
#else
float linearDepth=depth;
#endif
float focusNear=clamp(focus-dof,0.0,1.0);float focusFar=clamp(focus+dof,0.0,1.0);float low=step(linearDepth,focusNear);float high=step(focusFar,linearDepth);float factor=(linearDepth-focusNear)*low+(linearDepth-focusFar)*high;vec2 dofBlur=vec2(clamp(factor*aperture,-maxBlur,maxBlur));vec2 dofblur9=dofBlur*0.9;vec2 dofblur7=dofBlur*0.7;vec2 dofblur4=dofBlur*0.4;vec4 color=inputColor;color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.37,0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.40,0.0)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.37,-0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.15,-0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.15,0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.37,0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.37,-0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,-0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.37,0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.37,-0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.15,-0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.15,0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.37,0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.37,-0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.15,-0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.40,0.0)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.4,0.0)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofblur4);outputColor=color/41.0;}`, Aa = class extends B {
  /**
...
}, hi = "uniform float brightness;uniform float contrast;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=inputColor.rgb+vec3(brightness-0.5);if(contrast>0.0){color/=vec3(1.0-contrast);}else{color*=vec3(1.0+contrast);}outputColor=vec4(color+vec3(0.5),inputColor.a);}", xa = class extends B {
  /**
   ...
   */
  constructor({ blendFunction: e = m.SRC, brightness: t = 0, contrast: r = 0 } = {}) {
    super("BrightnessContrastEffect", hi, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["brightness", new c(t)],
        ["contrast", new c(r)]
      ])
    }), this.inputColorSpace = w;
  }
  /**
   * The brightness.
   *
...
}, di = "void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(vec3(average(inputColor.rgb)),inputColor.a);}", Ea = class extends B {
  /**
   ...
   */
  constructor(e) {
    super("ColorAverageEffect", di, { blendFunction: e });
  }
}, vi = "uniform float factor;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(floor(inputColor.rgb*factor+0.5)/factor,inputColor.a);}", Da = class extends B {
  /**
...
#endif
outputColor=vec4(ra.x,inputColor.g,ba.x,max(max(ra.y,ba.y),inputColor.a));}`, pi = "uniform vec2 offset;varying float vActive;varying vec2 vUvR;varying vec2 vUvB;void mainSupport(const in vec2 uv){vec2 shift=offset*vec2(1.0,aspect);vActive=(shift.x!=0.0||shift.y!=0.0)?1.0:0.0;vUvR=uv+shift;vUvB=uv-shift;}", wa = class extends B {
  /**
  ...
  constructor({
    ...
    super("ChromaticAberrationEffect", gi, {
      vertexShader: pi,
      attributes: N.CONVOLUTION,
      uniforms: /* @__PURE__ */ new Map([
        ["offset", new c(e)],
        ["modulationOffset", new c(r)]
      ])
...
}, mi = `void mainImage(const in vec4 inputColor,const in vec2 uv,const in float depth,out vec4 outputColor){
#ifdef INVERTED
vec3 color=vec3(1.0-depth);
#else
vec3 color=vec3(depth);
#endif
outputColor=vec4(color,inputColor.a);}`, Ta = class extends B {
  /**
...
vec4 maxValue=texture2D(inputBuffer,vUv);for(int i=0;i<8;++i){vec4 kernel=kernel16[i];vec2 uv=step*kernel.xy+vUv;maxValue=max(texture2D(inputBuffer,uv),maxValue);uv=step*kernel.zw+vUv;maxValue=max(texture2D(inputBuffer,uv),maxValue);}gl_FragColor=maxValue;
   ...
   */
  generateKernel() {
    const e = 2.39996323, t = new Float64Array(128), r = new Float64Array(32);
    let i = 0, s = 0;
    for (let a = 0, n = Math.sqrt(80); a < 80; ++a) {
      const o = a * e, l = Math.sqrt(a) / n, u = l * Math.cos(o), h = l * Math.sin(o);
      a % 5 === 0 ? (r[s++] = u, r[s++] = h) : (t[i++] = u, t[i++] = h);
    }
    this.uniforms.kernel64.value = t, this.uniforms.kernel16.value = r;
  }
  /**
   * Sets the texel size.
   *
...
void main(){float depth=readDepth(vUv);vec3 viewPosition=getViewPosition(vUv,depth);float distance=getDistance(viewPosition);float signedDistance=distance-focusDistance;float magnitude=smoothstep(0.0,focusRange,abs(signedDistance));gl_FragColor.rg=magnitude*vec2(step(signedDistance,0.0),step(0.0,signedDistance));}`, Ei = class extends U {
  ...
  constructor(e = null) {
    super({
      ...
      uniforms: {
        depthBuffer: new c(null),
        projectionMatrix: new c(null),
        projectionMatrixInverse: new c(null),
  ...
  copyCameraSettings(e) {
    this.uniforms.projectionMatrix.value = e.projectionMatrix, this.uniforms.projectionMatrixInverse.value = e.projectionMatrixInverse, this.uniforms.cameraNear.value = e.near, this.uniforms.cameraFar.value = e.far;
    const t = this.defines.PERSPECTIVE_CAMERA !== void 0;
    e instanceof pe ? t || (this.defines.PERSPECTIVE_CAMERA = true, this.needsUpdate = true) : t && (delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = true);
  }
}, Di = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
gl_FragColor=mask*texture2D(inputBuffer,vUv);
  ...
  constructor(e = null) {
    super({
      ...
      fragmentShader: Di,
      vertexShader: re
    }), this.colorChannel = ve.RED, this.maskFunction = Gt.DISCARD;
  }
  /**
   * The input buffer.
   *
  ...
  render(e, t, r, i, s) {
    ...
    t !== null && a !== void 0 && a[this.input] !== void 0 && (a[this.input].value = t.texture), e.setRenderTarget(this.renderToScreen ? null : r), e.render(this.scene, this.camera);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, r) {
    r !== void 0 && r !== H && (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
}, Ti = `#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#endif
vec4 result=inputColor*(1.0-cocNearFar.y)+colorFar;result=mix(result,colorNear,cocNearFar.x);outputColor=result;}`, Ci = /* @__PURE__ */ new z(), Ca = class extends B {
  /**
  ...
  constructor(e, {
    ...
    width: u,
    height: h,
    resolutionX: f = u || E.AUTO_SIZE,
    resolutionY: d = h || E.AUTO_SIZE
  } = {}) {
    super("DepthOfFieldEffect", Ti, {
      blendFunction: t,
      attributes: N.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
    ...
    }), this.camera = e, this.renderTarget = new y(1, 1, { depthBuffer: false }), this.renderTarget.texture.name = "DoF.Intermediate", this.renderTargetMasked = this.renderTarget.clone(), this.renderTargetMasked.texture.name = "DoF.Masked.Far", this.renderTargetNear = this.renderTarget.clone(), this.renderTargetNear.texture.name = "DoF.Bokeh.Near", this.uniforms.get("nearColorBuffer").value = this.renderTargetNear.texture, this.renderTargetFar = this.renderTarget.clone(), this.renderTargetFar.texture.name = "DoF.Bokeh.Far", this.uniforms.get("farColorBuffer").value = this.renderTargetFar.texture, this.renderTargetCoC = this.renderTarget.clone(), this.renderTargetCoC.texture.name = "DoF.CoC", this.uniforms.get("farCoCBuffer").value = this.renderTargetCoC.texture, this.renderTargetCoCBlurred = this.renderTargetCoC.clone(), this.renderTargetCoCBlurred.texture.name = "DoF.CoC.Blurred", this.uniforms.get("nearCoCBuffer").value = this.renderTargetCoCBlurred.texture, this.cocPass = new W(new Ei(e));
    const v = this.cocMaterial;
    v.focusDistance = a, v.focusRange = n, this.blurPass = new Pe({ resolutionScale: l, resolutionX: f, resolutionY: d, kernelSize: $.MEDIUM }), this.maskPass = new W(new wi(this.renderTargetCoC.texture));
    const A = this.maskPass.fullscreenMaterial;
    A.colorChannel = ve.GREEN, this.maskFunction = Gt.MULTIPLY_RGB, this.bokehNearBasePass = new W(new be(false, true)), this.bokehNearBasePass.fullscreenMaterial.cocBuffer = this.renderTargetCoCBlurred.texture, this.bokehNearFillPass = new W(new be(true, true)), this.bokehNearFillPass.fullscreenMaterial.cocBuffer = this.renderTargetCoCBlurred.texture, this.bokehFarBasePass = new W(new be(false, false)), this.bokehFarBasePass.fullscreenMaterial.cocBuffer = this.renderTargetCoC.texture, this.bokehFarFillPass = new W(new be(true, false)), this.bokehFarFillPass.fullscreenMaterial.cocBuffer = this.renderTargetCoC.texture, this.target = null;
    const p = this.resolution = new E(this, f, d, l);
    p.addEventListener("change", (x) => this.setSize(p.baseWidth, p.baseHeight)), this.bokehScale = o;
  }
  set mainCamera(e) {
  ...
  calculateFocusDistance(e) {
    return this.camera.getWorldPosition(Ci).distanceTo(e);
  }
  /**
   * Sets the depth texture.
   *
   ...
   */
  update(e, t, r) {
    const i = this.renderTarget, s = this.renderTargetCoC, a = this.renderTargetCoCBlurred, n = this.renderTargetMasked;
    if (this.target !== null) {
      const o = this.calculateFocusDistance(this.target);
      this.cocMaterial.focusDistance = o;
    }
    this.cocPass.render(e, null, s), this.blurPass.render(e, s, a), this.maskPass.render(e, t, n), this.bokehFarBasePass.render(e, n, i), this.bokehFarFillPass.render(e, i, this.renderTargetFar), this.bokehNearBasePass.render(e, t, i), this.bokehNearFillPass.render(e, i, this.renderTargetNear);
  }
  /**
   * Updates the size of internal render targets.
   *
  ...
  setSize(e, t) {
    ...
    r.setBaseSize(e, t);
    const i = r.width, s = r.height;
    this.cocPass.setSize(e, t), this.blurPass.setSize(e, t), this.maskPass.setSize(e, t), this.renderTargetFar.setSize(e, t), this.renderTargetCoC.setSize(e, t), this.renderTargetMasked.setSize(e, t), this.renderTarget.setSize(i, s), this.renderTargetNear.setSize(i, s), this.renderTargetCoCBlurred.setSize(i, s), this.bokehNearBasePass.fullscreenMaterial.setSize(e, t), this.bokehNearFillPass.fullscreenMaterial.setSize(e, t), this.bokehFarBasePass.fullscreenMaterial.setSize(e, t), this.bokehFarFillPass.fullscreenMaterial.setSize(e, t);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, r) {
    this.cocPass.initialize(e, t, r), this.maskPass.initialize(e, t, r), this.bokehNearBasePass.initialize(e, t, r), this.bokehNearFillPass.initialize(e, t, r), this.bokehFarBasePass.initialize(e, t, r), this.bokehFarFillPass.initialize(e, t, r), this.blurPass.initialize(e, t, H), e.capabilities.logarithmicDepthBuffer && (this.cocPass.fullscreenMaterial.defines.LOG_DEPTH = "1"), r !== void 0 && (this.renderTarget.texture.type = r, this.renderTargetNear.texture.type = r, this.renderTargetFar.texture.type = r, this.renderTargetMasked.texture.type = r, e !== null && e.outputColorSpace === w && (this.renderTarget.texture.colorSpace = w, this.renderTargetNear.texture.colorSpace = w, this.renderTargetFar.texture.colorSpace = w, this.renderTargetMasked.texture.colorSpace = w));
  }
}, Si = "uniform vec2 angle;uniform float scale;float pattern(const in vec2 uv){vec2 point=scale*vec2(dot(angle.yx,vec2(uv.x,-uv.y)),dot(angle,uv));return(sin(point.x)*sin(point.y))*4.0;}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(inputColor.rgb*10.0-5.0+pattern(uv*resolution));outputColor=vec4(color,inputColor.a);}", Sa = class extends B {
  /**
   ...
   */
  constructor({ blendFunction: e, angle: t = Math.PI * 0.5, scale: r = 1 } = {}) {
    super("DotScreenEffect", Si, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["angle", new c(new g())],
        ["scale", new c(r)]
...
varying vec2 vUvDown;varying vec2 vUvUp;varying vec2 vUvLeft;varying vec2 vUvRight;varying vec2 vUvDownLeft;varying vec2 vUvUpRight;varying vec2 vUvUpLeft;varying vec2 vUvDownRight;vec4 fxaa(const in vec4 inputColor,const in vec2 uv){float lumaCenter=luminance(inputColor.rgb);float lumaDown=luminance(texture2D(inputBuffer,vUvDown).rgb);float lumaUp=luminance(texture2D(inputBuffer,vUvUp).rgb);float lumaLeft=luminance(texture2D(inputBuffer,vUvLeft).rgb);float lumaRight=luminance(texture2D(inputBuffer,vUvRight).rgb);float lumaMin=min(lumaCenter,min(min(lumaDown,lumaUp),min(lumaLeft,lumaRight)));float lumaMax=max(lumaCenter,max(max(lumaDown,lumaUp),max(lumaLeft,lumaRight)));float lumaRange=lumaMax-lumaMin;if(lumaRange<max(EDGE_THRESHOLD_MIN,lumaMax*EDGE_THRESHOLD_MAX)){return inputColor;}float lumaDownLeft=luminance(texture2D(inputBuffer,vUvDownLeft).rgb);float lumaUpRight=luminance(texture2D(inputBuffer,vUvUpRight).rgb);float lumaUpLeft=luminance(texture2D(inputBuffer,vUvUpLeft).rgb);float lumaDownRight=luminance(texture2D(inputBuffer,vUvDownRight).rgb);float lumaDownUp=lumaDown+lumaUp;float lumaLeftRight=lumaLeft+lumaRight;float lumaLeftCorners=lumaDownLeft+lumaUpLeft;float lumaDownCorners=lumaDownLeft+lumaDownRight;float lumaRightCorners=lumaDownRight+lumaUpRight;float lumaUpCorners=lumaUpRight+lumaUpLeft;float edgeHorizontal=(abs(-2.0*lumaLeft+lumaLeftCorners)+abs(-2.0*lumaCenter+lumaDownUp)*2.0+abs(-2.0*lumaRight+lumaRightCorners));float edgeVertical=(abs(-2.0*lumaUp+lumaUpCorners)+abs(-2.0*lumaCenter+lumaLeftRight)*2.0+abs(-2.0*lumaDown+lumaDownCorners));bool isHorizontal=(edgeHorizontal>=edgeVertical);float stepLength=isHorizontal?texelSize.y:texelSize.x;float luma1=isHorizontal?lumaDown:lumaLeft;float luma2=isHorizontal?lumaUp:lumaRight;float gradient1=abs(luma1-lumaCenter);float gradient2=abs(luma2-lumaCenter);bool is1Steepest=gradient1>=gradient2;float gradientScaled=0.25*max(gradient1,gradient2);float lumaLocalAverage=0.0;if(is1Steepest){stepLength=-stepLength;lumaLocalAverage=0.5*(luma1+lumaCenter);}else{lumaLocalAverage=0.5*(luma2+lumaCenter);}vec2 currentUv=uv;if(isHorizontal){currentUv.y+=stepLength*0.5;}else{currentUv.x+=stepLength*0.5;}vec2 offset=isHorizontal?vec2(texelSize.x,0.0):vec2(0.0,texelSize.y);vec2 uv1=currentUv-offset*QUALITY(0);vec2 uv2=currentUv+offset*QUALITY(0);float lumaEnd1=luminance(texture2D(inputBuffer,uv1).rgb);float lumaEnd2=luminance(texture2D(inputBuffer,uv2).rgb);lumaEnd1-=lumaLocalAverage;lumaEnd2-=lumaLocalAverage;bool reached1=abs(lumaEnd1)>=gradientScaled;bool reached2=abs(lumaEnd2)>=gradientScaled;bool reachedBoth=reached1&&reached2;if(!reached1){uv1-=offset*QUALITY(1);}if(!reached2){uv2+=offset*QUALITY(1);}if(!reachedBoth){for(int i=2;i<SAMPLES;++i){if(!reached1){lumaEnd1=luminance(texture2D(inputBuffer,uv1).rgb);lumaEnd1=lumaEnd1-lumaLocalAverage;}if(!reached2){lumaEnd2=luminance(texture2D(inputBuffer,uv2).rgb);lumaEnd2=lumaEnd2-lumaLocalAverage;}reached1=abs(lumaEnd1)>=gradientScaled;reached2=abs(lumaEnd2)>=gradientScaled;reachedBoth=reached1&&reached2;if(!reached1){uv1-=offset*QUALITY(i);}if(!reached2){uv2+=offset*QUALITY(i);}if(reachedBoth){break;}}}float distance1=isHorizontal?(uv.x-uv1.x):(uv.y-uv1.y);float distance2=isHorizontal?(uv2.x-uv.x):(uv2.y-uv.y);bool isDirection1=distance1<distance2;float distanceFinal=min(distance1,distance2);float edgeThickness=(distance1+distance2);bool isLumaCenterSmaller=lumaCenter<lumaLocalAverage;bool correctVariation1=(lumaEnd1<0.0)!=isLumaCenterSmaller;bool correctVariation2=(lumaEnd2<0.0)!=isLumaCenterSmaller;bool correctVariation=isDirection1?correctVariation1:correctVariation2;float pixelOffset=-distanceFinal/edgeThickness+0.5;float finalOffset=correctVariation?pixelOffset:0.0;float lumaAverage=ONE_OVER_TWELVE*(2.0*(lumaDownUp+lumaLeftRight)+lumaLeftCorners+lumaRightCorners);float subPixelOffset1=clamp(abs(lumaAverage-lumaCenter)/lumaRange,0.0,1.0);float subPixelOffset2=(-2.0*subPixelOffset1+3.0)*subPixelOffset1*subPixelOffset1;float subPixelOffsetFinal=subPixelOffset2*subPixelOffset2*SUBPIXEL_QUALITY;finalOffset=max(finalOffset,subPixelOffsetFinal);vec2 finalUv=uv;if(isHorizontal){finalUv.y+=finalOffset*stepLength;}else{finalUv.x+=finalOffset*stepLength;}return texture2D(inputBuffer,finalUv);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=fxaa(inputColor,uv);}`, Mi = "varying vec2 vUvDown;varying vec2 vUvUp;varying vec2 vUvLeft;varying vec2 vUvRight;varying vec2 vUvDownLeft;varying vec2 vUvUpRight;varying vec2 vUvUpLeft;varying vec2 vUvDownRight;void mainSupport(const in vec2 uv){vUvDown=uv+vec2(0.0,-1.0)*texelSize;vUvUp=uv+vec2(0.0,1.0)*texelSize;vUvRight=uv+vec2(1.0,0.0)*texelSize;vUvLeft=uv+vec2(-1.0,0.0)*texelSize;vUvDownLeft=uv+vec2(-1.0,-1.0)*texelSize;vUvUpRight=uv+vec2(1.0,1.0)*texelSize;vUvUpLeft=uv+vec2(-1.0,1.0)*texelSize;vUvDownRight=uv+vec2(1.0,-1.0)*texelSize;}", Ba = class extends B {
...
}, Ii = "uniform float gamma;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=LinearToGamma(max(inputColor,0.0),gamma);}", Ma = class extends B {
  /**
  ...
  constructor({ blendFunction: e = m.SRC, gamma: t = 2 } = {}) {
    super("GammaCorrectionEffect", Ii, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["gamma", new c(t)]
      ])
...
function Pi(e, t, r) {
  ...
  let s;
  if (i.has(t) || console.error("Invalid noise texture format"), r === H) {
...
var it = class extends Ut {
   ...
   */
  constructor(e, t, r = Rt, i = H) {
    super(Pi(e * t, r, i), e, t, r, i), this.needsUpdate = true;
  }
}, yi = "uniform lowp sampler2D perturbationMap;uniform bool active;uniform float columns;uniform float random;uniform vec2 seeds;uniform vec2 distortion;void mainUv(inout vec2 uv){if(active){if(uv.y<distortion.x+columns&&uv.y>distortion.x-columns*random){float sx=clamp(ceil(seeds.x),0.0,1.0);uv.y=sx*(1.0-(uv.y+distortion.y))+(1.0-sx)*distortion.y;}if(uv.x<distortion.y+columns&&uv.x>distortion.y-columns*random){float sy=clamp(ceil(seeds.y),0.0,1.0);uv.x=sy*distortion.x+(1.0-sy)*(1.0-(uv.x+distortion.x));}vec2 normal=texture2D(perturbationMap,uv*random*random).rg;uv+=normal*seeds*(random*0.2);}}", Le = "Glitch.Generated";
function Q(e, t) {
  return e + Math.random() * (t - e);
}
var Ia = class extends B {
  /**
  ...
  constructor({
    ...
    duration: r = new g(0.6, 1),
    strength: i = new g(0.3, 1),
    columns: s = 0.05,
    ratio: a = 0.85,
    perturbationMap: n = null,
    dtSize: o = 64
  } = {}) {
    if (super("GlitchEffect", yi, {
      uniforms: /* @__PURE__ */ new Map([
      ...
      const l = new it(o, o, ae);
      l.name = Le, this.perturbationMap = l;
    } else
      this.perturbationMap = n;
    this.time = 0, this.distortion = this.uniforms.get("distortion").value, this.delay = t, this.duration = r, this.breakPoint = new g(
      Q(this.delay.x, this.delay.y),
      Q(this.duration.x, this.duration.y)
    ), this.strength = i, this.mode = me.SPORADIC, this.ratio = a, this.chromaticAberrationOffset = e;
  }
  /**
   * Random number seeds.
   *
  ...
  set perturbationMap(e) {
    ...
    t !== null && t.name === Le && t.dispose(), e.minFilter = e.magFilter = _, e.wrapS = e.wrapT = Be, e.generateMipmaps = false, this.uniforms.get("perturbationMap").value = e;
  }
  /**
   ...
   */
  update(e, t, r) {
    const i = this.mode, s = this.breakPoint, a = this.chromaticAberrationOffset, n = this.strength;
    let o = this.time, l = false, u = 0, h = 0, f;
    i !== me.DISABLED && (i === me.SPORADIC && (o += r, f = o > s.x, o >= s.x + s.y && (s.set(
      Q(this.delay.x, this.delay.y),
      Q(this.duration.x, this.duration.y)
    ), o = 0)), u = Math.random(), this.uniforms.get("random").value = u, f && u > this.ratio || i === me.CONSTANT_WILD ? (l = true, u *= n.y * 0.03, h = Q(-Math.PI, Math.PI), this.seeds.set(Q(-n.y, n.y), Q(-n.y, n.y)), this.distortion.set(Q(0, 1), Q(0, 1))) : (f || i === me.CONSTANT_MILD) && (l = true, u *= n.x * 0.03, h = Q(-Math.PI, Math.PI), this.seeds.set(Q(-n.x, n.x), Q(-n.x, n.x)), this.distortion.set(Q(0, 1), Q(0, 1))), this.time = o), a !== null && (l ? a.set(Math.cos(h), Math.sin(h)).multiplyScalar(u) : a.set(0, 0)), this.uniforms.get("active").value = l;
  }
  /**
...
#include <dithering_fragment>
  ...
  constructor(e, t, r = null) {
    super("RenderPass", e, t), this.needsSwap = false, this.clearPass = new Ie(), this.overrideMaterialManager = r === null ? null : new vt(r), this.ignoreBackground = false, this.skipShadowMapUpdate = false, this.selection = null;
  }
  set mainScene(e) {
    this.scene = e;
  }
  ...
  set overrideMaterial(e) {
    ...
    e !== null ? t !== null ? t.setMaterial(e) : this.overrideMaterialManager = new vt(e) : t !== null && (t.dispose(), this.overrideMaterialManager = null);
  }
  /**
   ...
   */
  render(e, t, r, i, s) {
    const a = this.scene, n = this.camera, o = this.selection, l = n.layers.mask, u = a.background, h = e.shadowMap.autoUpdate, f = this.renderToScreen ? null : t;
    o !== null && n.layers.set(o.getLayer()), this.skipShadowMapUpdate && (e.shadowMap.autoUpdate = false), (this.ignoreBackground || this.clearPass.overrideClearColor !== null) && (a.background = null), this.clearPass.enabled && this.clearPass.render(e, t), e.setRenderTarget(f), this.overrideMaterialManager !== null ? this.overrideMaterialManager.render(e, a, n) : e.render(a, n), n.layers.mask = l, a.background = u, e.shadowMap.autoUpdate = h;
  }
}, bi = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv);}`, Ze = /* @__PURE__ */ new z(), gt = /* @__PURE__ */ new tt(), Pa = class extends B {
  /**
  ...
  constructor(e, t, {
    ...
    blur: u = true,
    kernelSize: h = $.SMALL,
    resolutionScale: f = 0.5,
    width: d = E.AUTO_SIZE,
    height: v = E.AUTO_SIZE,
    resolutionX: A = d,
    resolutionY: p = v
  } = {}) {
    super("GodRaysEffect", bi, {
      blendFunction: r,
      attributes: N.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["map", new c(null)]
      ])
    }), this.camera = e, this._lightSource = t, this.lightSource = t, this.lightScene = new $e(), this.screenPosition = new g(), this.renderTargetA = new y(1, 1, { depthBuffer: false }), this.renderTargetA.texture.name = "GodRays.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "GodRays.Target.B", this.uniforms.get("map").value = this.renderTargetB.texture, this.renderTargetLight = new y(1, 1), this.renderTargetLight.texture.name = "GodRays.Light", this.renderTargetLight.depthTexture = new Pt(), this.renderPassLight = new Qe(this.lightScene, e), this.renderPassLight.clearPass.enabled = false, this.blurPass = new Pe({ kernelSize: h }), this.blurPass.enabled = u, this.copyPass = new lt(this.renderTargetLight), this.copyPass.fullscreenMaterial.channelWeights = new oe(0, 0, 0, 1), this.godRaysPass = new W(new Ri(this.screenPosition));
    const x = this.godRaysMaterial;
    x.density = s, x.decay = a, x.weight = n, x.exposure = o, x.maxIntensity = l, x.samples = i;
    const C = this.resolution = new E(this, A, p, f);
    C.addEventListener("change", (T) => this.setSize(C.baseWidth, C.baseHeight));
  }
  set mainCamera(e) {
   ...
   */
  update(e, t, r) {
    const i = this.lightSource, s = i.parent, a = i.matrixAutoUpdate, n = this.renderTargetA, o = this.renderTargetLight;
    i.material.depthWrite = true, i.matrixAutoUpdate = false, i.updateWorldMatrix(true, false), s !== null && (a || gt.copy(i.matrix), i.matrix.copy(i.matrixWorld)), this.lightScene.add(i), this.copyPass.render(e, t), this.renderPassLight.render(e, o), i.material.depthWrite = false, i.matrixAutoUpdate = a, s !== null && (a || i.matrix.copy(gt), s.add(i)), Ze.setFromMatrixPosition(i.matrixWorld).project(this.camera), this.screenPosition.set(
      Math.min(Math.max((Ze.x + 1) * 0.5, -1), 2),
      Math.min(Math.max((Ze.y + 1) * 0.5, -1), 2)
    );
    let l = o;
    this.blurPass.enabled && (this.blurPass.render(e, l, n), l = n), this.godRaysPass.render(e, l, this.renderTargetB);
  }
  /**
   * Updates the size of internal render targets.
   *
  ...
  setSize(e, t) {
    ...
    r.setBaseSize(e, t);
    const i = r.width, s = r.height;
    this.renderTargetLight.setSize(e, t), this.renderTargetA.setSize(i, s), this.renderTargetB.setSize(i, s), this.blurPass.resolution.copy(r);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, r) {
    this.blurPass.initialize(e, t, r), this.renderPassLight.initialize(e, t, r), this.copyPass.initialize(e, t, r), this.godRaysPass.initialize(e, t, r), r !== void 0 && (this.renderTargetA.texture.type = r, this.renderTargetB.texture.type = r, this.renderTargetLight.texture.type = r, e !== null && e.outputColorSpace === w && (this.renderTargetA.texture.colorSpace = w, this.renderTargetB.texture.colorSpace = w, this.renderTargetLight.texture.colorSpace = w));
  }
}, Li = "uniform vec2 scale;uniform float lineWidth;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float grid=0.5-max(abs(mod(uv.x*scale.x,1.0)-0.5),abs(mod(uv.y*scale.y,1.0)-0.5));outputColor=vec4(vec3(smoothstep(0.0,lineWidth,grid)),inputColor.a);}", ya = class extends B {
  /**
   ...
   */
  constructor({ blendFunction: e = m.OVERLAY, scale: t = 1, lineWidth: r = 0 } = {}) {
    super("GridEffect", Li, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["scale", new c(new g())],
    ...
    }), this.resolution = new g(), this.s = 0, this.scale = t, this.l = 0, this.lineWidth = r;
  }
  /**
   * The scale.
   *
  ...
  setSize(e, t) {
    ...
    const r = e / t, i = this.scale * (t * 0.125);
    this.uniforms.get("scale").value.set(r * i, i), this.uniforms.get("lineWidth").value = i / t + this.lineWidth;
  }
}, Fi = "uniform vec3 hue;uniform float saturation;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(dot(inputColor.rgb,hue.xyz),dot(inputColor.rgb,hue.zxy),dot(inputColor.rgb,hue.yzx));float average=(color.r+color.g+color.b)/3.0;vec3 diff=average-color;if(saturation>0.0){color+=diff*(1.0-1.0/(1.001-saturation));}else{color+=diff*-saturation;}outputColor=vec4(min(color,1.0),inputColor.a);}", Ua = class extends B {
  /**
   ...
   */
  constructor({ blendFunction: e = m.SRC, hue: t = 0, saturation: r = 0 } = {}) {
    super("HueSaturationEffect", Fi, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["hue", new c(new z())],
        ["saturation", new c(r)]
  ...
  set hue(e) {
    const t = Math.sin(e), r = Math.cos(e);
  ...
  constructor({
    ...
    focalLength: r = new g(1, 1),
    skew: i = 0
  } = {}) {
    super("LensDistortionEffect", Oi, {
      uniforms: /* @__PURE__ */ new Map([
        ["distortion", new c(e)],
...
#endif
void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(texture2D(lut,vec2(inputColor.r,0.5)).r,texture2D(lut,vec2(inputColor.g,0.5)).r,texture2D(lut,vec2(inputColor.b,0.5)).r,inputColor.a);}`, ba = class extends B {
  /**
  ...
  set lut(e) {
    this.uniforms.get("lut").value = e, e !== null && (e.type === Y || e.type === bt) && this.defines.set("LUT_PRECISION_HIGH", "1");
  }
}, Hi = {
...
function pt(e, t, r) {
  ...
  if (i.width = e, i.height = t, r instanceof Image)
    s.drawImage(r, 0, 0);
  else {
    const a = s.createImageData(e, t);
    a.data.set(r), s.putImageData(a, 0, 0);
  }
  return i;
}
var ne = class kt {
   ...
   */
  constructor(t = 0, r = 0, i = null) {
    this.width = t, this.height = r, this.data = i;
  }
  /**
   ...
   */
  toCanvas() {
    return typeof document > "u" ? null : pt(this.width, this.height, this.data);
  }
  /**
  ...
  static from(t) {
    ...
    if (t instanceof Image) {
      const a = pt(r, i, t);
      a !== null && (s = a.getContext("2d").getImageData(0, 0, r, i).data);
    } else
      s = t.data;
    return new kt(r, i, s);
  }
}, Gi = `"use strict";(()=>{var O={SCALE_UP:"lut.scaleup"};var _=[new Float32Array(3),new Float32Array(3)],n=[new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array(3)],Z=[[new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1])]];function d(a,t,r,m){let i=r[0]-t[0],e=r[1]-t[1],y=r[2]-t[2],h=a[0]-t[0],A=a[1]-t[1],w=a[2]-t[2],c=e*w-y*A,l=y*h-i*w,x=i*A-e*h,u=Math.sqrt(c*c+l*l+x*x),b=u*.5,s=c/u,F=l/u,f=x/u,p=-(a[0]*s+a[1]*F+a[2]*f),M=m[0]*s+m[1]*F+m[2]*f;return Math.abs(M+p)*b/3}function V(a,t,r,m,i,e){let y=(r+m*t+i*t*t)*4;e[0]=a[y+0],e[1]=a[y+1],e[2]=a[y+2]}function k(a,t,r,m,i,e){let y=r*(t-1),h=m*(t-1),A=i*(t-1),w=Math.floor(y),c=Math.floor(h),l=Math.floor(A),x=Math.ceil(y),u=Math.ceil(h),b=Math.ceil(A),s=y-w,F=h-c,f=A-l;if(w===y&&c===h&&l===A)V(a,t,y,h,A,e);else{let p;s>=F&&F>=f?p=Z[0]:s>=f&&f>=F?p=Z[1]:f>=s&&s>=F?p=Z[2]:F>=s&&s>=f?p=Z[3]:F>=f&&f>=s?p=Z[4]:f>=F&&F>=s&&(p=Z[5]);let[M,g,X,Y]=p,P=_[0];P[0]=s,P[1]=F,P[2]=f;let o=_[1],L=x-w,S=u-c,U=b-l;o[0]=L*M[0]+w,o[1]=S*M[1]+c,o[2]=U*M[2]+l,V(a,t,o[0],o[1],o[2],n[0]),o[0]=L*g[0]+w,o[1]=S*g[1]+c,o[2]=U*g[2]+l,V(a,t,o[0],o[1],o[2],n[1]),o[0]=L*X[0]+w,o[1]=S*X[1]+c,o[2]=U*X[2]+l,V(a,t,o[0],o[1],o[2],n[2]),o[0]=L*Y[0]+w,o[1]=S*Y[1]+c,o[2]=U*Y[2]+l,V(a,t,o[0],o[1],o[2],n[3]);let T=d(g,X,Y,P)*6,q=d(M,X,Y,P)*6,C=d(M,g,Y,P)*6,E=d(M,g,X,P)*6;n[0][0]*=T,n[0][1]*=T,n[0][2]*=T,n[1][0]*=q,n[1][1]*=q,n[1][2]*=q,n[2][0]*=C,n[2][1]*=C,n[2][2]*=C,n[3][0]*=E,n[3][1]*=E,n[3][2]*=E,e[0]=n[0][0]+n[1][0]+n[2][0]+n[3][0],e[1]=n[0][1]+n[1][1]+n[2][1]+n[3][1],e[2]=n[0][2]+n[1][2]+n[2][2]+n[3][2]}}var v=class{static expand(t,r){let m=Math.cbrt(t.length/4),i=new Float32Array(3),e=new t.constructor(r**3*4),y=t instanceof Uint8Array?255:1,h=r**2,A=1/(r-1);for(let w=0;w<r;++w)for(let c=0;c<r;++c)for(let l=0;l<r;++l){let x=l*A,u=c*A,b=w*A,s=Math.round(l+c*r+w*h)*4;k(t,m,x,u,b,i),e[s+0]=i[0],e[s+1]=i[1],e[s+2]=i[2],e[s+3]=y}return e}};self.addEventListener("message",a=>{let t=a.data,r=t.data;t.operation===O.SCALE_UP&&(r=v.expand(r,t.size)),postMessage(r,[r.buffer]),close()});})();
`, mt = /* @__PURE__ */ new K(), ct = class Ge extends He {
  /**
   ...
   */
  constructor(t, r) {
    super(t, r, r, r), this.type = Y, this.format = ae, this.minFilter = X, this.magFilter = X, this.wrapS = Ye, this.wrapT = Ye, this.wrapR = Ye, this.unpackAlignment = 1, this.needsUpdate = true, this.colorSpace = ze, this.domainMin = new z(0, 0, 0), this.domainMax = new z(1, 1, 1);
  }
  /**
  ...
  scaleUp(t, r = true) {
    const i = this.image;
    let s;
    return t <= i.width ? s = Promise.reject(new Error("The target size must be greater than the current size")) : s = new Promise((a, n) => {
      const o = URL.createObjectURL(new Blob([Gi], {
        type: "text/javascript"
      })), l = new Worker(o);
      l.addEventListener("error", (h) => n(h.error)), l.addEventListener("message", (h) => {
        const f = new Ge(h.data, t);
        this.colorSpace = f.colorSpace, f.type = this.type, f.name = this.name, URL.revokeObjectURL(o), a(f);
      });
      const u = r ? [i.data.buffer] : [];
      l.postMessage({
        operation: Hi.SCALE_UP,
        data: i.data,
        size: t
      }, u);
    }), s;
   ...
   */
  applyLUT(t) {
    const r = this.image, i = t.image, s = Math.min(r.width, r.height, r.depth), a = Math.min(i.width, i.height, i.depth);
    if (s !== a)
      console.error("Size mismatch");
    else if (t.type !== Y || this.type !== Y)
      console.error("Both LUTs must be FloatType textures");
    else if (t.format !== ae || this.format !== ae)
      console.error("Both LUTs must be RGBA textures");
    else {
      const n = r.data, o = i.data, l = s, u = l ** 2, h = l - 1;
      for (let f = 0, d = l ** 3; f < d; ++f) {
        const v = f * 4, A = n[v + 0] * h, p = n[v + 1] * h, x = n[v + 2] * h, C = Math.round(A + p * l + x * u) * 4;
        n[v + 0] = o[C + 0], n[v + 1] = o[C + 1], n[v + 2] = o[C + 2];
      }
  ...
  convertToUint8() {
    if (this.type === Y) {
      const t = this.image.data, r = new Uint8Array(t.length);
      for (let i = 0, s = t.length; i < s; ++i)
        r[i] = t[i] * 255 + 0.5;
      this.image.data = r, this.type = H, this.needsUpdate = true;
    }
    return this;
  }
  /**
  ...
  convertToFloat() {
    if (this.type === H) {
      const t = this.image.data, r = new Float32Array(t.length);
      for (let i = 0, s = t.length; i < s; ++i)
        r[i] = t[i] / 255;
      this.image.data = r, this.type = Y, this.needsUpdate = true;
    }
    return this;
  }
  /**
  ...
  convertLinearToSRGB() {
    ...
    if (this.type === Y) {
      for (let r = 0, i = t.length; r < i; r += 4)
        mt.fromArray(t, r).convertLinearToSRGB().toArray(t, r);
      this.colorSpace = w, this.needsUpdate = true;
    } else
  ...
  convertSRGBToLinear() {
    ...
    if (this.type === Y) {
      for (let r = 0, i = t.length; r < i; r += 4)
        mt.fromArray(t, r).convertSRGBToLinear().toArray(t, r);
   ...
   */
  toDataTexture() {
    const t = this.image.width, r = this.image.height * this.image.depth, i = new Ut(this.image.data, t, r);
    return i.name = this.name, i.type = this.type, i.format = this.format, i.minFilter = X, i.magFilter = X, i.wrapS = this.wrapS, i.wrapT = this.wrapT, i.generateMipmaps = false, i.needsUpdate = true, this.colorSpace = i.colorSpace, i;
  }
  /**
   ...
   */
  static from(t) {
    const r = t.image, { width: i, height: s } = r, a = Math.min(i, s);
    let n;
    if (r instanceof Image) {
      const u = ne.from(r).data;
      if (i > s) {
        n = new Uint8Array(u.length);
        for (let h = 0; h < a; ++h)
          for (let f = 0; f < a; ++f)
            for (let d = 0; d < a; ++d) {
              const v = (d + h * a + f * a * a) * 4, A = (d + f * a + h * a * a) * 4;
  ...
  static createNeutral(t) {
    const r = new Float32Array(t ** 3 * 4), i = t ** 2, s = 1 / (t - 1);
    for (let n = 0; n < t; ++n)
      for (let o = 0; o < t; ++o)
        for (let l = 0; l < t; ++l) {
          const u = (n + o * t + l * i) * 4;
          r[u + 0] = n * s, r[u + 1] = o * s, r[u + 2] = l * s, r[u + 3] = 1;
        }
    const a = new Ge(r, t);
    return a.name = "neutral", a;
  }
}, ki = `uniform vec3 scale;uniform vec3 offset;
...
#endif
outputColor=vec4(c,inputColor.a);}`, La = class extends B {
  /**
   * Constructs a new color grading effect.
   *
   * @param {Texture} lut - The lookup texture.
  ...
  constructor(e, {
    ...
    tetrahedralInterpolation: r = false,
    inputColorSpace: i = w
  } = {}) {
    super("LUT3DEffect", ki, {
      blendFunction: t,
      uniforms: /* @__PURE__ */ new Map([
        ["lut", new c(null)],
        ["scale", new c(new z())],
    ...
    }), this.tetrahedralInterpolation = r, this.inputColorSpace = i, this.lut = e;
  }
  /**
   * The LUT.
   *
  ...
  set lut(e) {
    const t = this.defines, r = this.uniforms;
    if (this.lut !== e && (r.get("lut").value = e, e !== null)) {
      const i = e.image, s = this.tetrahedralInterpolation;
      if (t.clear(), t.set("LUT_SIZE", Math.min(i.width, i.height).toFixed(16)), t.set("LUT_TEXEL_WIDTH", (1 / i.width).toFixed(16)), t.set("LUT_TEXEL_HEIGHT", (1 / i.height).toFixed(16)), r.get("domainMin").value = null, r.get("domainMax").value = null, (e.type === Y || e.type === bt) && t.set("LUT_PRECISION_HIGH", "1"), i.width > i.height ? t.set("LUT_STRIP_HORIZONTAL", "1") : e instanceof He && t.set("LUT_3D", "1"), e instanceof ct) {
        const a = e.domainMin, n = e.domainMax;
        (a.x !== 0 || a.y !== 0 || a.z !== 0 || n.x !== 1 || n.y !== 1 || n.z !== 1) && (t.set("CUSTOM_INPUT_DOMAIN", "1"), r.get("domainMin").value = a.clone(), r.get("domainMax").value = n.clone());
      }
  ...
  updateScaleOffset() {
    const e = this.lut;
    if (e !== null) {
      const t = Math.min(e.image.width, e.image.height), r = this.uniforms.get("scale").value, i = this.uniforms.get("offset").value;
      if (this.tetrahedralInterpolation && e instanceof He)
        if (this.defines.has("CUSTOM_INPUT_DOMAIN")) {
          ...
          r.setScalar(t - 1).divide(s), i.copy(e.domainMin).negate().multiply(r);
        } else
          r.setScalar(t - 1), i.setScalar(0);
      else if (this.defines.has("CUSTOM_INPUT_DOMAIN")) {
        const s = e.domainMax.clone().sub(e.domainMin).multiplyScalar(t);
        r.setScalar(t - 1).divide(s), i.copy(e.domainMin).negate().multiply(r).addScalar(1 / (2 * t));
      } else
        r.setScalar((t - 1) / t), i.setScalar(1 / (2 * t));
    }
  }
  /**
  ...
  configureTetrahedralInterpolation() {
    const e = this.lut;
    e !== null && (e.minFilter = X, e.magFilter = X, this.tetrahedralInterpolation && (e instanceof He ? (e.minFilter = _, e.magFilter = _) : console.warn("Tetrahedral interpolation requires a 3D texture")), e.needsUpdate = true);
  }
  /**
...
}, _i = `void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 noise=vec3(rand(uv*(1.0+time)));
#ifdef PREMULTIPLY
...
outputColor=vec4(noise,inputColor.a);
  ...
  constructor({ blendFunction: e = m.SCREEN, premultiply: t = false } = {}) {
    super("NoiseEffect", _i, { blendFunction: e }), this.premultiply = t;
  }
  /**
...
#endif
float depthTest=(-vViewZ>-viewZ)?1.0:0.0;gl_FragColor.rg=vec2(0.0,depthTest);}`, Vi = `#include <common>
...
#include <clipping_planes_vertex>
   ...
   */
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNear.value = e.near, this.uniforms.cameraFar.value = e.far, e instanceof pe ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = true);
  }
}, Wi = "uniform lowp sampler2D inputBuffer;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 c0=texture2D(inputBuffer,vUv0).rg;vec2 c1=texture2D(inputBuffer,vUv1).rg;vec2 c2=texture2D(inputBuffer,vUv2).rg;vec2 c3=texture2D(inputBuffer,vUv3).rg;float d0=(c0.x-c1.x)*0.5;float d1=(c2.x-c3.x)*0.5;float d=length(vec2(d0,d1));float a0=min(c0.y,c1.y);float a1=min(c2.y,c3.y);float visibilityFactor=min(a0,a1);gl_FragColor.rg=(1.0-visibilityFactor>0.001)?vec2(d,0.0):vec2(0.0,d);}", Xi = "uniform vec2 texelSize;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vUv0=vec2(uv.x+texelSize.x,uv.y);vUv1=vec2(uv.x-texelSize.x,uv.y);vUv2=vec2(uv.x,uv.y+texelSize.y);vUv3=vec2(uv.x,uv.y-texelSize.y);gl_Position=vec4(position.xy,1.0,1.0);}", Ki = class extends U {
  /**
  ...
  constructor(e, t, {
    ...
    l.skipShadowMapUpdate = true, l.ignoreBackground = true, this.renderTarget = r, this.renderTarget === void 0 && (this.renderTarget = new y(1, 1, {
      minFilter: _,
      magFilter: _
    }), this.renderTarget.texture.name = "DepthPass.Target");
    const u = this.resolution = new E(this, n, o, i);
   ...
   */
  initialize(e, t, r) {
    const i = e.capabilities.reversedDepthBuffer ? 0 : 16777215, s = this.renderPass.clearPass;
    s.overrideClearColor = new K(i), s.overrideClearAlpha = 1;
  }
}, Zi = `uniform lowp sampler2D edgeTexture;uniform lowp sampler2D maskTexture;uniform vec3 visibleEdgeColor;uniform vec3 hiddenEdgeColor;uniform float pulse;uniform float edgeStrength;
#ifdef USE_PATTERN
...
outputColor=vec4(color,max(alpha,inputColor.a));
#endif
}`, ji = "uniform float patternScale;varying vec2 vUvPattern;void mainSupport(const in vec2 uv){vUvPattern=uv*vec2(aspect,1.0)*patternScale;}", Na = class extends B {
  /**
  ...
  constructor(e, t, {
    ...
    super("OutlineEffect", Zi, {
      uniforms: /* @__PURE__ */ new Map([
        ["maskTexture", new c(null)],
        ["edgeTexture", new c(null)],
        ["edgeStrength", new c(a)],
        ["visibleEdgeColor", new c(new K(o))],
        ["hiddenEdgeColor", new c(new K(l))],
        ["pulse", new c(1)],
    ...
    }), this.blendMode.blendFunction = r, this.patternTexture = i, this.xRay = f, this.scene = e, this.camera = t, this.renderTargetMask = new y(1, 1), this.renderTargetMask.samples = d, this.renderTargetMask.texture.name = "Outline.Mask", this.uniforms.get("maskTexture").value = this.renderTargetMask.texture, this.renderTargetOutline = new y(1, 1, { depthBuffer: false }), this.renderTargetOutline.texture.name = "Outline.Edges", this.uniforms.get("edgeTexture").value = this.renderTargetOutline.texture, this.clearPass = new Ie(), this.clearPass.overrideClearColor = new K(0), this.clearPass.overrideClearAlpha = 1, this.depthPass = new _t(e, t), this.maskPass = new Qe(e, t, new Yi(this.depthPass.texture, t));
    const T = this.maskPass.clearPass;
    T.overrideClearColor = new K(16777215), T.overrideClearAlpha = 1, this.blurPass = new Pe({ resolutionScale: v, resolutionX: x, resolutionY: C, kernelSize: u }), this.blurPass.enabled = h;
    const D = this.blurPass.resolution;
    D.addEventListener("change", (Z) => this.setSize(D.baseWidth, D.baseHeight)), this.outlinePass = new W(new Ki());
    const G = this.outlinePass.fullscreenMaterial;
    G.inputBuffer = this.renderTargetMask.texture, this.time = 0, this.forceUpdate = true, this.selection = new Ot(), this.pulseSpeed = n;
  }
  set mainScene(e) {
  ...
  set patternTexture(e) {
    e !== null ? (e.wrapS = e.wrapT = Be, this.defines.set("USE_PATTERN", "1"), this.setVertexShader(ji)) : (this.defines.delete("USE_PATTERN"), this.setVertexShader(null)), this.uniforms.get("patternTexture").value = e, this.setChanged();
  }
  /**
   ...
   */
  update(e, t, r) {
    const i = this.scene, s = this.camera, a = this.selection, o = this.uniforms.get("pulse"), l = i.background, u = s.layers.mask;
    (this.forceUpdate || a.size > 0) && (i.background = null, o.value = 1, this.pulseSpeed > 0 && (o.value = Math.cos(this.time * this.pulseSpeed * 10) * 0.375 + 0.625), this.time += r, a.setVisible(false), this.depthPass.render(e), a.setVisible(true), s.layers.set(a.layer), this.maskPass.render(e, this.renderTargetMask), s.layers.mask = u, i.background = l, this.outlinePass.render(e, null, this.renderTargetOutline), this.blurPass.enabled && this.blurPass.render(e, this.renderTargetOutline, this.renderTargetOutline)), this.forceUpdate = a.size > 0;
  }
  /**
   * Updates the size of internal render targets.
   *
  ...
  setSize(e, t) {
    ...
    r.setBaseSize(e, t);
    const i = r.width, s = r.height;
    this.depthPass.setSize(i, s), this.renderTargetOutline.setSize(i, s), this.outlinePass.fullscreenMaterial.setSize(i, s);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, r) {
    this.blurPass.initialize(e, t, H), r !== void 0 && (this.depthPass.initialize(e, t, r), this.maskPass.initialize(e, t, r), this.outlinePass.initialize(e, t, r));
  }
}, Ji = "uniform bool active;uniform vec4 d;void mainUv(inout vec2 uv){if(active){uv=d.xy*(floor(uv*d.zw)+0.5);}}", Ha = class extends B {
  /**
  ...
  setSize(e, t) {
    const r = this.resolution;
    r.set(e, t);
    const i = this.granularity, s = i / r.x, a = i / r.y;
    this.uniforms.get("d").value.set(s, a, 1 / s, 1 / a);
  }
}, qi = `uniform float focus;uniform float focalLength;uniform float fStop;uniform float maxBlur;uniform float luminanceThreshold;uniform float luminanceGain;uniform float bias;uniform float fringe;
#ifdef MANUAL_DOF
uniform vec4 dof;
#endif
#ifdef PENTAGON
...
#endif
outputColor=vec4(color,inputColor.a);}`, Ga = class extends B {
  /**
   * Constructs a new bokeh effect.
   *
   * @param {Object} [options] - The options.
  ...
  constructor({
    ...
    }), this.rings = u, this.samples = h, this.showFocus = f, this.manualDoF = d, this.pentagon = v;
  }
  /**
  ...
  set manualDoF(e) {
    this.manualDoF !== e && (e ? (this.defines.set("MANUAL_DOF", "1"), this.uniforms.get("dof").value = new oe(0.2, 1, 0.2, 2)) : (this.defines.delete("MANUAL_DOF"), this.uniforms.get("dof").value = null), this.setChanged());
  }
  /**
...
y+=time*scrollSpeed;
#endif
vec2 sl=vec2(sin(y*count),cos(y*count));outputColor=vec4(sl.xyx,inputColor.a);}`, ka = class extends B {
  /**
   ...
   */
  constructor({ blendFunction: e = m.OVERLAY, density: t = 1.25, scrollSpeed: r = 0 } = {}) {
    super("ScanlineEffect", $i, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["count", new c(0)],
        ["scrollSpeed", new c(0)]
...
}, es = "uniform bool active;uniform vec2 center;uniform float waveSize;uniform float radius;uniform float maxRadius;uniform float amplitude;varying float vSize;void mainUv(inout vec2 uv){if(active){vec2 aspectCorrection=vec2(aspect,1.0);vec2 difference=uv*aspectCorrection-center*aspectCorrection;float distance=sqrt(dot(difference,difference))*vSize;if(distance>radius){if(distance<radius+waveSize){float angle=(distance-radius)*PI2/waveSize;float cosSin=(1.0-cos(angle))*0.5;float extent=maxRadius+waveSize;float decay=max(extent-distance*distance,0.0)/extent;uv-=((cosSin*amplitude*difference)/distance)*decay;}}}}", ts = "uniform float size;uniform float cameraDistance;varying float vSize;void mainSupport(){vSize=(0.1*cameraDistance)/size;}", rs = Math.PI * 0.5, Ee = /* @__PURE__ */ new z(), At = /* @__PURE__ */ new z(), za = class extends B {
  /**
  ...
  constructor(e, t = new z(), {
    ...
    }), this.position = t, this.speed = r, this.camera = e, this.screenPosition = this.uniforms.get("center").value, this.time = 0, this.active = false;
  }
  set mainCamera(e) {
    this.camera = e;
  }
   ...
   */
  update(e, t, r) {
    const i = this.position, s = this.camera, a = this.uniforms, n = a.get("active");
    if (this.active) {
      const o = a.get("waveSize").value;
      s.getWorldDirection(Ee), At.copy(s.position).sub(i), n.value = Ee.angleTo(At) > rs, n.value && (a.get("cameraDistance").value = s.position.distanceTo(i), Ee.copy(i).project(s), this.screenPosition.set((Ee.x + 1) * 0.5, (Ee.y + 1) * 0.5)), this.time += r * this.speed;
      const l = this.time - o;
...
bool keep=!isMaxDepth&&depthTest(depth.x,depth.y);
#endif
if(keep){gl_FragColor=texture2D(inputBuffer,vUv);}else{discard;}}`, ss = class extends U {
  /**
   ...
   */
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNearFar.value.set(e.near, e.far), e instanceof pe ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = true);
  }
}, _a = class extends ui {
  /**
   ...
   */
  constructor(e, t, r) {
    super(r), this.setAttributes(this.getAttributes() | N.DEPTH), this.camera = t, this.depthPass = new _t(e, t), this.clearPass = new Ie(true, false, false), this.clearPass.overrideClearColor = new K(0), this.depthMaskPass = new W(new ss());
    const i = this.depthMaskMaterial;
    i.copyCameraSettings(t), i.depthBuffer1 = this.depthPass.texture, i.depthPacking1 = q, i.depthMode = et, this.renderTargetMasked = new y(1, 1, { depthBuffer: false }), this.renderTargetMasked.texture.name = "Bloom.Masked", this.selection = new Ot(), this._inverted = false, this._ignoreBackground = false;
  }
  set mainScene(e) {
  ...
  set inverted(e) {
    this._inverted = e, this.depthMaskMaterial.depthMode = e ? Lt : et;
  }
  /**
   * Indicates whether the mask is inverted.
   *
   ...
   */
  update(e, t, r) {
    const i = this.camera, s = this.selection, a = this.inverted;
    let n = t;
    if (this.ignoreBackground || !a || s.size > 0) {
      const o = i.layers.mask;
      i.layers.set(s.layer), this.depthPass.render(e), i.layers.mask = o, n = this.renderTargetMasked, this.clearPass.render(e, n), this.depthMaskPass.render(e, t, n);
    }
    super.update(e, n, r);
  }
  /**
   ...
   */
  initialize(e, t, r) {
    super.initialize(e, t, r), this.clearPass.initialize(e, t, r), this.depthPass.initialize(e, t, r), this.depthMaskPass.initialize(e, t, r), e !== null && e.capabilities.logarithmicDepthBuffer && (this.depthMaskPass.fullscreenMaterial.defines.LOG_DEPTH = "1"), r !== void 0 && (this.renderTargetMasked.texture.type = r, e !== null && e.outputColorSpace === w && (this.renderTargetMasked.texture.colorSpace = w));
  }
}, as = "uniform vec3 weightsR;uniform vec3 weightsG;uniform vec3 weightsB;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(dot(inputColor.rgb,weightsR),dot(inputColor.rgb,weightsG),dot(inputColor.rgb,weightsB));outputColor=vec4(color,inputColor.a);}", Qa = class extends B {
  /**
  ...
  constructor({ blendFunction: e, intensity: t = 1 } = {}) {
    super("SepiaEffect", as, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["weightsR", new c(new z(0.393, 0.769, 0.189))],
        ["weightsG", new c(new z(0.349, 0.686, 0.168))],
        ["weightsB", new c(new z(0.272, 0.534, 0.131))]
      ])
    });
  }
  /**
...
}, ns = `varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, ls = class extends U {
  /**
...
}, cs = `#define sampleLevelZeroOffset(t, coord, offset) texture2D(t, coord + offset * texelSize)
#if __VERSION__ < 300
...
vec2 d;vec3 coords;coords.x=searchXLeft(vOffset[0].xy,vOffset[2].x);coords.y=vOffset[1].y;d.x=coords.x;float e1=texture2D(inputBuffer,coords.xy).r;coords.z=searchXRight(vOffset[0].zw,vOffset[2].y);d.y=coords.z;d=round(resolution.xx*d+-vPixCoord.xx);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.zy,vec2(1,0)).r;weights.rg=area(sqrtD,e1,e2,subsampleIndices.y);coords.y=vUv.y;detectHorizontalCornerPattern(weights.rg,coords.xyzy,d);
  ...
  constructor({
    ...
    preset: t = Ae.MEDIUM,
    edgeDetectionMode: r = zt.COLOR,
    predicationMode: i = zi.DISABLED
  } = {}) {
    super("SMAAEffect", hs, {
      vertexShader: ds,
      blendFunction: e,
    ...
    let s, a;
    arguments.length > 1 && (s = arguments[0], a = arguments[1], arguments.length > 2 && (t = arguments[2]), arguments.length > 3 && (r = arguments[3])), this.renderTargetEdges = new y(1, 1, { depthBuffer: false }), this.renderTargetEdges.texture.name = "SMAA.Edges", this.renderTargetWeights = this.renderTargetEdges.clone(), this.renderTargetWeights.texture.name = "SMAA.Weights", this.uniforms.get("weightMap").value = this.renderTargetWeights.texture, this.clearPass = new Ie(true, false, false), this.clearPass.overrideClearColor = new K(0), this.clearPass.overrideClearAlpha = 1, this.edgeDetectionPass = new W(new ls()), this.edgeDetectionMaterial.edgeDetectionMode = r, this.edgeDetectionMaterial.predicationMode = i, this.weightsPass = new W(new fs());
    const n = new le();
    n.onLoad = () => {
      const o = new ke(s);
      o.name = "SMAA.Search", o.magFilter = _, o.minFilter = _, o.generateMipmaps = false, o.needsUpdate = true, o.flipY = true, this.weightsMaterial.searchTexture = o;
      const l = new ke(a);
      l.name = "SMAA.Area", l.magFilter = X, l.minFilter = X, l.generateMipmaps = false, l.needsUpdate = true, l.flipY = false, this.weightsMaterial.areaTexture = l, this.dispatchEvent({ type: "load" });
...
function Ce(e, t, r) {
  return Math.min(Math.max((e + t) / (t - r), 0), 1);
}
var vs = `#include <common>
#include <packing>
...
ao=clamp(1.0-pow(1.0-ao,abs(intensity)),0.0,1.0);
#endif
}gl_FragColor.r=ao;}`, gs = "uniform vec2 noiseScale;varying vec2 vUv;varying vec2 vUv2;void main(){vUv=position.xy*0.5+0.5;vUv2=vUv*noiseScale;gl_Position=vec4(position.xy,1.0,1.0);}", ps = class extends U {
  /**
  ...
  set worldDistanceThreshold(e) {
    this.distanceThreshold = Ce(-e, this.near, this.far);
  }
  /**
  ...
  set worldDistanceFalloff(e) {
    this.distanceFalloff = Ce(-e, this.near, this.far);
  }
  /**
  ...
  set worldProximityThreshold(e) {
    this.proximityThreshold = Ce(-e, this.near, this.far);
  }
  /**
  ...
  set worldProximityFalloff(e) {
    this.proximityFalloff = Ce(-e, this.near, this.far);
  }
  /**
   ...
   */
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNearFar.value.set(e.near, e.far), this.uniforms.projectionMatrix.value.copy(e.projectionMatrix), this.uniforms.inverseProjectionMatrix.value.copy(e.projectionMatrix).invert(), e instanceof pe ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = true);
  }
  /**
   * Sets the size of this object.
   *
   ...
   */
  setSize(e, t) {
    const r = this.uniforms, i = r.noiseTexture.value;
    i !== null && r.noiseScale.value.set(
      e / i.image.width,
      t / i.image.height
...
#endif
gl_FragColor=vec4(n[index],d[index]);}`, As = "uniform vec2 texelSize;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vUv0=uv;vUv1=vec2(uv.x,uv.y+texelSize.y);vUv2=vec2(uv.x+texelSize.x,uv.y);vUv3=uv+texelSize;gl_Position=vec4(position.xy,1.0,1.0);}", xs = class extends U {
  /**
  ...
  constructor({
    ...
    const n = new xs();
    n.normalBuffer = e, this.fullscreenMaterial = n, this.needsDepthTexture = true, this.needsSwap = false, this.renderTarget = new y(1, 1, {
      minFilter: _,
      magFilter: _,
      depthBuffer: false,
      type: Y
...
}, Ds = `uniform lowp sampler2D aoBuffer;uniform float luminanceInfluence;uniform float intensity;
...
outputColor=vec4(vec3(1.0-ao),inputColor.a);
  ...
  constructor(e, t, {
    ...
    super("SSAOEffect", Ds, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["luminanceInfluence", new c(x)],
        ["color", new c(null)],
        ["intensity", new c(T)],
        ["scale", new c(0)]
        // Unused.
      ])
    }), this.renderTarget = new y(1, 1, { depthBuffer: false }), this.renderTarget.texture.name = "AO.Target", this.uniforms.get("aoBuffer").value = this.renderTarget.texture;
    const ee = this.resolution = new E(this, ce, ue, j);
    ee.addEventListener("change", (ye) => this.setSize(ee.baseWidth, ee.baseHeight)), this.camera = e, this.depthDownsamplingPass = new Es({ normalBuffer: t, resolutionScale: j }), this.depthDownsamplingPass.enabled = a === null, this.ssaoPass = new W(new ps(e));
    const ie = new it(xt, xt, ae);
    ie.wrapS = ie.wrapT = Be;
    const b = this.ssaoMaterial;
    b.normalBuffer = t, b.noiseTexture = ie, b.minRadiusScale = p, b.samples = i, b.radius = C, b.rings = s, b.fade = G, b.bias = D, b.distanceThreshold = f, b.distanceFalloff = d, b.proximityThreshold = v, b.proximityFalloff = A, o !== void 0 && (b.worldDistanceThreshold = o), l !== void 0 && (b.worldDistanceFalloff = l), u !== void 0 && (b.worldProximityThreshold = u), h !== void 0 && (b.worldProximityFalloff = h), a !== null && (this.ssaoMaterial.normalDepthBuffer = a, this.defines.set("NORMAL_DEPTH", "1")), this.depthAwareUpsampling = n, this.color = Z;
  }
  set mainCamera(e) {
  ...
  set color(e) {
    ...
    e !== null ? r.has("COLORIZE") ? t.get("color").value.set(e) : (r.set("COLORIZE", "1"), t.get("color").value = new K(e), this.setChanged()) : r.has("COLORIZE") && (r.delete("COLORIZE"), t.get("color").value = null, this.setChanged());
  }
  /**
  ...
  update(e, t, r) {
    ...
    this.depthDownsamplingPass.enabled && this.depthDownsamplingPass.render(e), this.ssaoPass.render(e, null, i);
  }
  /**
   * Sets the size.
   *
  ...
  setSize(e, t) {
    ...
    r.setBaseSize(e, t);
    const i = r.width, s = r.height;
    this.ssaoMaterial.copyCameraSettings(this.camera), this.ssaoMaterial.setSize(i, s), this.renderTarget.setSize(i, s), this.depthDownsamplingPass.resolution.scale = r.scale, this.depthDownsamplingPass.setSize(e, t);
  }
  /**
   * Performs initialization tasks.
   *
  ...
  initialize(e, t, r) {
    try {
      ...
      i === null && (this.depthDownsamplingPass.initialize(e, t, r), i = this.depthDownsamplingPass.texture, this.uniforms.get("normalDepthBuffer").value = i, this.ssaoMaterial.normalDepthBuffer = i, this.defines.set("NORMAL_DEPTH", "1"));
    } catch {
      this.depthDownsamplingPass.enabled = false;
    }
  }
}, ws = `#ifdef TEXTURE_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
...
#endif
outputColor=TEXEL;outputColor.a=max(inputColor.a,outputColor.a);}`, Ts = `#ifdef ASPECT_CORRECTION
uniform float scale;
#else
...
vUv2=(uvTransform*vec3(uv,1.0)).xy;
   ...
   */
  constructor({ blendFunction: e, texture: t = null, aspectCorrection: r = false } = {}) {
    super("TextureEffect", ws, {
      blendFunction: e,
      defines: /* @__PURE__ */ new Map([
        ["TEXEL", "texel"]
      ]),
  ...
  set texture(e) {
    const t = this.texture, r = this.uniforms, i = this.defines;
    t !== e && (r.get("map").value = e, r.get("uvTransform").value = e.matrix, i.delete("TEXTURE_PRECISION_HIGH"), e !== null && (e.matrixAutoUpdate ? (i.set("UV_TRANSFORM", "1"), this.setVertexShader(Ts)) : (i.delete("UV_TRANSFORM"), this.setVertexShader(null)), e.type !== H && i.set("TEXTURE_PRECISION_HIGH", "1"), (t === null || t.type !== e.type || t.encoding !== e.encoding) && this.setChanged()));
  }
  /**
   * Returns the texture.
   *
   ...
   */
  setTextureSwizzleRGBA(e, t = e, r = e, i = e) {
    const s = "rgba";
    let a = "";
    (e !== ve.RED || t !== ve.GREEN || r !== ve.BLUE || i !== ve.ALPHA) && (a = [".", s[e], s[t], s[r], s[i]].join("")), this.defines.set("TEXEL", "texel" + a), this.setChanged();
  }
  /**
   * Updates this effect.
   *
...
}, Cs = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, Ss = "uniform vec4 texelSize;uniform float kernel;uniform float scale;uniform float aspect;uniform vec2 rotation;varying vec2 vUv;varying vec2 vUv2;varying vec2 vOffset;void main(){vec2 uv=position.xy*0.5+0.5;vUv=uv;vUv2=(uv-0.5)*2.0*vec2(aspect,1.0);vUv2=vec2(dot(rotation,vUv2),dot(rotation,vec2(vUv2.y,-vUv2.x)));vOffset=(texelSize.xy*vec2(kernel)+texelSize.zw)*scale;gl_Position=vec4(position.xy,1.0,1.0);}", Bs = class extends Nt {
  /**
  ...
  constructor({
    ...
    super(), this.fragmentShader = Cs, this.vertexShader = Ss, this.kernelSize = e, this.uniforms.aspect = new c(1), this.uniforms.rotation = new c(new g()), this.uniforms.maskParams = new c(new oe()), this._offset = t, this._focusArea = i, this._feather = s, this.rotation = r, this.updateParams();
  }
  /**
  ...
  constructor({
    ...
    super({ kernelSize: s, resolutionScale: a, resolutionX: n, resolutionY: o }), this.blurMaterial = new Bs({ kernelSize: s, offset: e, rotation: t, focusArea: r, feather: i });
  }
...
uniform lowp sampler2D map;
#endif
uniform vec2 maskParams;varying vec2 vUv2;float linearGradientMask(const in float x){return step(maskParams.x,x)-step(maskParams.y,x);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float mask=linearGradientMask(vUv2.y);vec4 texel=texture2D(map,uv);outputColor=mix(texel,inputColor,mask);}`, Ps = "uniform vec2 rotation;varying vec2 vUv2;void mainSupport(const in vec2 uv){vUv2=(uv-0.5)*2.0*vec2(aspect,1.0);vUv2=vec2(dot(rotation,vUv2),dot(rotation,vec2(vUv2.y,-vUv2.x)));}", Xa = class extends B {
  /**
  ...
  constructor({
    ...
    }), this._offset = t, this._focusArea = i, this._feather = s, this.renderTarget = new y(1, 1, { depthBuffer: false }), this.renderTarget.texture.name = "TiltShift.Target", this.uniforms.get("map").value = this.renderTarget.texture, this.blurPass = new Ms({
      kernelSize: a,
      resolutionScale: n,
      resolutionX: o,
      resolutionY: l,
    ...
    u.addEventListener("change", (h) => this.setSize(u.baseWidth, u.baseHeight)), this.rotation = r, this.updateParams();
  }
  /**
   ...
   */
  initialize(e, t, r) {
    this.blurPass.initialize(e, t, r), r !== void 0 && (this.renderTarget.texture.type = r, e !== null && e.outputColorSpace === w && (this.renderTarget.texture.colorSpace = w));
  }
}, ys = `#include <packing>
...
#endif
l0=max(minLuminance,l0);l1=max(minLuminance,l1);float adaptedLum=l0+(l1-l0)*(1.0-exp(-deltaTime*tau));gl_FragColor=(adaptedLum==1.0)?vec4(1.0):packFloatToRGBA(adaptedLum);}`, Us = class extends U {
  /**
  ...
  constructor(e, { minLuminance: t = 0.01, adaptationRate: r = 1 } = {}) {
    super("AdaptiveLuminancePass"), this.fullscreenMaterial = new Us(), this.needsSwap = false, this.renderTargetPrevious = new y(1, 1, {
      minFilter: _,
      magFilter: _,
      depthBuffer: false
    }), this.renderTargetPrevious.texture.name = "Luminance.Previous";
    const i = this.fullscreenMaterial;
    i.luminanceBuffer0 = this.renderTargetPrevious.texture, i.luminanceBuffer1 = e, i.minLuminance = t, i.adaptationRate = r, this.renderTargetAdapted = this.renderTargetPrevious.clone(), this.renderTargetAdapted.texture.name = "Luminance.Adapted", this.copyPass = new lt(this.renderTargetPrevious, false);
  }
  /**
...
}, bs = `#include <tonemapping_pars_fragment>
...
outputColor=vec4(toneMapping(inputColor.rgb),inputColor.a);
  ...
  constructor({
    blendFunction: e = m.SRC,
    adaptive: t = false,
    mode: r = t ? V.REINHARD2_ADAPTIVE : V.AGX,
    resolution: i = 256,
    maxLuminance: s = 4,
    whitePoint: a = s,
    middleGrey: n = 0.6,
    ...
    }), this.renderTargetLuminance = new y(1, 1, {
      minFilter: qt,
      depthBuffer: false
    }), this.renderTargetLuminance.texture.generateMipmaps = true, this.renderTargetLuminance.texture.name = "Luminance", this.luminancePass = new Ht({
      renderTarget: this.renderTargetLuminance
    }), this.adaptiveLuminancePass = new Rs(this.luminancePass.texture, {
      minLuminance: o,
      adaptationRate: u
    }), this.uniforms.get("luminanceBuffer").value = this.adaptiveLuminancePass.texture, this.resolution = i, this.mode = r;
  }
  /**
  ...
  set mode(e) {
    if (this.mode === e)
      return;
    const r = Me.replace(/\D+/g, "") >= 168 ? "CineonToneMapping(texel)" : "OptimizedCineonToneMapping(texel)";
    ...
    this.adaptiveLuminancePass.enabled = e === V.REINHARD2_ADAPTIVE, this.setChanged();
  }
  /**
   ...
   */
  get adaptive() {
    return this.mode === V.REINHARD2_ADAPTIVE;
  }
  set adaptive(e) {
    this.mode = e ? V.REINHARD2_ADAPTIVE : V.REINHARD2;
  }
  /**
   * The luminance adaptation rate.
   *
...
}, Ls = `uniform float offset;uniform float darkness;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){const vec2 center=vec2(0.5);vec3 color=inputColor.rgb;
#if VIGNETTE_TECHNIQUE == 0
float d=distance(uv,center);color*=smoothstep(0.8,offset*0.799,d*(darkness+offset));
#else
vec2 coord=(uv-center)*vec2(offset);color=mix(color,vec3(1.0-darkness),dot(coord,coord));
#endif
outputColor=vec4(color,inputColor.a);}`, Za = class extends B {
  /**
  ...
  constructor({
    blendFunction: e,
    eskil: t = false,
    technique: r = t ? xe.ESKIL : xe.DEFAULT,
    offset: i = 0.5,
    darkness: s = 0.5
  } = {}) {
    super("VignetteEffect", Ls, {
      blendFunction: e,
      defines: /* @__PURE__ */ new Map([
   ...
   */
  get eskil() {
    return this.technique === xe.ESKIL;
  }
  /**
   * Indicates whether Eskil's Vignette technique is enabled.
   *
   ...
   */
  set eskil(e) {
    this.technique = e ? xe.ESKIL : xe.DEFAULT;
  }
  /**
  ...
  load(e, t = () => {
    ...
    const s = this.manager, a = new le(), n = new Ft(a);
    n.setPath(this.path), n.setResponseType("text"), s.itemStart(e), n.load(e, (o) => {
      try {
  ...
  loadAsync(e, t = () => {
    ...
    const r = this.manager, i = new le();
    return new Promise((s, a) => {
      i.onError = (n) => {
        r.itemError(n), a(`Failed to load ${n}`);
      }, this.load(e, s, t);
    });
  }
  /**
   ...
   */
  parse(e) {
    const t = /^[\d ]+$/m, r = /^([\d.e+-]+) +([\d.e+-]+) +([\d.e+-]+) *$/gm;
    let i = t.exec(e);
    if (i === null)
      throw new Error("Missing grid information");
    const s = i[0].trim().split(/\s+/g).map((v) => Number(v)), a = s[1] - s[0], n = s.length, o = n ** 2;
    ...
    let u = 0, h = 0;
    for (; (i = r.exec(e)) !== null; ) {
      const v = Number(i[1]), A = Number(i[2]), p = Number(i[3]);
      u = Math.max(u, v, A, p);
      const x = h % n, C = Math.floor(h / n) % n, T = Math.floor(h / o) % n, D = (x * o + C * n + T) * 4;
      l[D + 0] = v, l[D + 1] = A, l[D + 2] = p, l[D + 3] = 1, ++h;
    }
    const f = Math.ceil(Math.log2(u)), d = Math.pow(2, f);
  ...
  load(e, t = () => {
    ...
    const s = this.manager, a = new le(), n = new Ft(a);
    n.setPath(this.path), n.setResponseType("text"), n.load(e, (o) => {
      try {
        const l = this.parse(o);
        s.itemEnd(e), t(l);
      } catch (l) {
   ...
   */
  parse(e) {
    const t = /TITLE +"([^"]*)"/, r = /LUT_3D_SIZE +(\d+)/, i = /DOMAIN_MIN +([\d.]+) +([\d.]+) +([\d.]+)/, s = /DOMAIN_MAX +([\d.]+) +([\d.]+) +([\d.]+)/, a = /^([\d.e+-]+) +([\d.e+-]+) +([\d.e+-]+) *$/gm;
    let n = t.exec(e);
    const o = n !== null ? n[1] : null;
    if (n = r.exec(e), n === null)
      throw new Error("Missing LUT_3D_SIZE information");
    const l = Number(n[1]), u = new Float32Array(l ** 3 * 4), h = new z(0, 0, 0), f = new z(1, 1, 1);
    if (n = i.exec(e), n !== null && h.set(Number(n[1]), Number(n[2]), Number(n[3])), n = s.exec(e), n !== null && f.set(Number(n[1]), Number(n[2]), Number(n[3])), h.x > f.x || h.y > f.y || h.z > f.z)
      throw h.set(0, 0, 0), f.set(1, 1, 1), new Error("Invalid input domain");
    let d = 0;
    for (; (n = a.exec(e)) !== null; )
      u[d++] = Number(n[1]), u[d++] = Number(n[2]), u[d++] = Number(n[3]), u[d++] = 1;
    const v = new ct(u, l);
    return v.domainMin.copy(h), v.domainMax.copy(f), o !== null && (v.name = o), v;
  }
}, qa = class extends ot {
  /**
  ...
  load(e = () => {
    ...
    return new Promise((s, a) => {
      ...
      i.onError = (l) => {
        r.itemError(l), t !== null ? (t(`Failed to load ${l}`), s()) : a(`Failed to load ${l}`);
      }, i.onLoad = () => {
        const l = [n, o];
        e(l), s(l);
      ...
      }), r.itemStart("smaa-search"), r.itemStart("smaa-area"), i.itemStart("smaa-search"), i.itemStart("smaa-area"), n.src = st, o.src = at;
    });
  }
}, Fs = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#endif
}`, Os = `uniform vec2 texelSize;uniform float scale;
#if KERNEL_SIZE == 3
varying vec2 vUv00,vUv01,vUv02;varying vec2 vUv03,vUv04,vUv05;varying vec2 vUv06,vUv07,vUv08;
#elif KERNEL_SIZE == 5 && MAX_VARYING_VECTORS >= 13
varying vec2 vUv00,vUv01,vUv02,vUv03,vUv04;varying vec2 vUv05,vUv06,vUv07,vUv08,vUv09;varying vec2 vUv10,vUv11,vUv12,vUv13,vUv14;varying vec2 vUv15,vUv16,vUv17,vUv18,vUv19;varying vec2 vUv20,vUv21,vUv22,vUv23,vUv24;
...
vUv=uv;
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, Ns = class extends U {
  /**
   ...
   */
  get worldDistanceThreshold() {
    return -Te(Number(this.defines.DISTANCE_THRESHOLD), this.near, this.far);
  }
  set worldDistanceThreshold(e) {
    const t = Ce(-e, this.near, this.far);
...
#endif
#include <dithering_fragment>
}`, _s = "uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}", Qs = class extends U {
  /**
...
}, Vs = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, Ys = "uniform vec2 texelSize;uniform vec2 direction;uniform float scale;varying vec2 vOffset;varying vec2 vUv;void main(){vOffset=direction*texelSize*scale;vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}", Ws = class extends U {
  /**
   * Constructs a new convolution material.
   *
   * @param {Object} [options] - The options.
   ...
   */
  generateKernel(e) {
    const t = new dr(e), r = t.linearSteps, i = new Float64Array(r * 2);
    for (let s = 0, a = 0; s < r; ++s)
      i[a++] = t.linearOffsets[s], i[a++] = t.linearWeights[s];
    this.uniforms.kernel.value = i, this.defines.STEPS = r.toFixed(0), this.needsUpdate = true;
  }
  /**
   * Sets the size of this object.
   *
  ...
  constructor({
    ...
    super("BoxBlurPass"), this.needsDepthTexture = r, this.renderTargetA = new y(1, 1, { depthBuffer: false }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = new y(1, 1, { depthBuffer: false }), this.renderTargetB.texture.name = "Blur.Target.B", this.blurMaterial = new Ns({ bilateral: r, kernelSize: e }), this.copyMaterial = new _e();
    const n = this.resolution = new E(this, s, a, i);
  ...
  render(e, t, r, i, s) {
    ...
    this.fullscreenMaterial = u;
    let h = t;
    for (let f = 0, d = Math.max(this.iterations, 1); f < d; ++f) {
      const v = f & 1 ? l : o;
      u.inputBuffer = h.texture, e.setRenderTarget(v), e.render(a, n), h = v;
    }
    this.copyMaterial.inputBuffer = h.texture, this.fullscreenMaterial = this.copyMaterial, e.setRenderTarget(this.renderToScreen ? null : r), e.render(a, n);
  }
  /**
   * Updates the size of this pass.
   *
   ...
   */
  initialize(e, t, r) {
    e !== null && (this.blurMaterial.maxVaryingVectors = e.capabilities.maxVaryings), r !== void 0 && (this.renderTargetA.texture.type = r, this.renderTargetB.texture.type = r, r !== H ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === w && (this.renderTargetA.texture.colorSpace = w, this.renderTargetB.texture.colorSpace = w));
  }
}, Xs = class extends O {
  /**
  ...
  constructor({ depthPacking: e = q } = {}) {
    super("DepthCopyPass");
    const t = new ks();
    t.outputDepthPacking = e, this.fullscreenMaterial = t, this.needsDepthTexture = true, this.needsSwap = false, this.renderTarget = new y(1, 1, {
      type: e === q ? H : Y,
      minFilter: _,
      magFilter: _,
      depthBuffer: false
...
}, Ks = Number(Me.replace(/\D+/g, "")), se = 255 / 256, Zs = new Float32Array([
  se / 256 ** 3,
  se / 256 ** 2,
  se / 256,
  se
...
function Js(e) {
  const t = Ks >= 167 ? js : Zs;
  return (e[0] * t[0] + e[1] * t[1] + e[2] * t[2] + e[3] * t[3]) / 255;
}
var en = class extends Xs {
  /**
   ...
   */
  constructor({ depthPacking: e = q, mode: t = we.SINGLE } = {}) {
    if (e !== q && e !== F)
  ...
  render(e, t, r, i, s) {
    ...
    if (n === we.FULL && super.render(e), this.callback !== null) {
      const o = this.renderTarget, l = this.pixelBuffer, u = o.texture.type !== Y;
      let h = 0, f = 0;
      if (n === we.SINGLE)
        super.render(e);
      else {
        const d = a.texelPosition;
        h = Math.round(d.x * o.width), f = Math.round(d.y * o.height);
      }
      e.readRenderTargetPixels(o, h, f, 1, 1, l), this.callback(u ? Js(l) : l[0]), this.callback = null;
    }
  }
  /**
   * Updates the size of this pass.
   ...
   */
  setSize(e, t) {
    this.fullscreenMaterial.mode === we.FULL && super.setSize(e, t);
  }
};
function Et(e, t, r) {
  for (const i of t) {
    const s = "$1" + e + i.charAt(0).toUpperCase() + i.slice(1), a = new RegExp("([^\\.])(\\b" + i + "\\b)", "g");
    for (const n of r.entries())
      n[1] !== null && r.set(n[0], n[1].replace(a, s));
  }
}
function qs(e, t, r) {
  let i = t.getFragmentShader(), s = t.getVertexShader();
  const a = i !== void 0 && /mainImage/.test(i), n = i !== void 0 && /mainUv/.test(i);
  if (r.attributes |= t.getAttributes(), i === void 0)
    throw new Error(`Missing fragment shader (${t.name})`);
  if (n && r.attributes & N.CONVOLUTION)
  ...
  {
    const o = /\w+\s+(\w+)\([\w\s,]*\)\s*{/g, l = r.shaderParts;
    let u = l.get(S.FRAGMENT_HEAD) || "", h = l.get(S.FRAGMENT_MAIN_UV) || "", f = l.get(S.FRAGMENT_MAIN_IMAGE) || "", d = l.get(S.VERTEX_HEAD) || "", v = l.get(S.VERTEX_MAIN_SUPPORT) || "";
    const A = /* @__PURE__ */ new Set(), p = /* @__PURE__ */ new Set();
    if (n && (h += `	${e}MainUv(UV);
`, r.uvTransformation = true), s !== null && /mainSupport/.test(s)) {
      const T = /mainSupport *\([\w\s]*?uv\s*?\)/.test(s);
      v += `	${e}MainSupport(`, v += T ? `vUv);
` : `);
`;
      for (const D of s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
        for (const G of D[1].split(/\s*,\s*/))
          r.varyings.add(G), A.add(G), p.add(G);
      for (const D of s.matchAll(o))
        p.add(D[1]);
    }
    for (const T of i.matchAll(o))
      p.add(T[1]);
    for (const T of t.defines.keys())
      p.add(T.replace(/\([\w\s,]*\)/g, ""));
    for (const T of t.uniforms.keys())
      p.add(T);
    p.delete("while"), p.delete("for"), p.delete("if"), t.uniforms.forEach((T, D) => r.uniforms.set(e + D.charAt(0).toUpperCase() + D.slice(1), T)), t.defines.forEach((T, D) => r.defines.set(e + D.charAt(0).toUpperCase() + D.slice(1), T));
    const x = /* @__PURE__ */ new Map([["fragment", i], ["vertex", s]]);
    Et(e, p, r.defines), Et(e, p, x), i = x.get("fragment"), s = x.get("vertex");
    const C = t.blendMode;
    if (r.blendModes.set(C.blendFunction, C), a) {
      t.inputColorSpace !== null && t.inputColorSpace !== r.colorSpace && (f += t.inputColorSpace === w ? `color0 = sRGBTransferOETF(color0);
	` : `color0 = sRGBToLinear(color0);
	`), t.outputColorSpace !== yt ? r.colorSpace = t.outputColorSpace : t.inputColorSpace !== null && (r.colorSpace = t.inputColorSpace);
      const T = /MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;
      f += `${e}MainImage(color0, UV, `, r.attributes & N.DEPTH && T.test(i) && (f += "depth, ", r.readDepth = true), f += `color1);
	`;
      const D = e + "BlendOpacity";
      r.uniforms.set(D, C.opacity), f += `color0 = blend${C.blendFunction}(color0, color1, ${D});
...
`;
    ...
    if (u += i + `
`, s !== null && (d += s + `
`), l.set(S.FRAGMENT_HEAD, u), l.set(S.FRAGMENT_MAIN_UV, h), l.set(S.FRAGMENT_MAIN_IMAGE, f), l.set(S.VERTEX_HEAD, d), l.set(S.VERTEX_MAIN_SUPPORT, v), t.extensions !== null)
...
var tn = class extends O {
   ...
   */
  constructor(e, ...t) {
    super("EffectPass"), this.fullscreenMaterial = new Qs(null, null, null, e), this.listener = (r) => this.handleEvent(r), this.effects = [], this.setEffects(t), this.skipRendering = false, this.minTime = 1, this.maxTime = Number.POSITIVE_INFINITY, this.timeScale = 1;
  }
  set mainScene(e) {
  ...
  updateMaterial() {
    ...
    let r = e.shaderParts.get(S.FRAGMENT_HEAD), i = e.shaderParts.get(S.FRAGMENT_MAIN_IMAGE), s = e.shaderParts.get(S.FRAGMENT_MAIN_UV);
    const a = /\bblend\b/g;
    for (const n of e.blendModes.values())
      r += n.getShaderCode().replace(a, `blend${n.blendFunction}`) + `
`;
    e.attributes & N.DEPTH ? (e.readDepth && (i = `float depth = readDepth(UV);

	` + i), this.needsDepthTexture = this.getDepthTexture() === null) : this.needsDepthTexture = false, e.colorSpace === w && (i += `color0 = sRGBToLinear(color0);
	`), e.uvTransformation ? (s = `vec2 transformedUv = vUv;
` + s, e.defines.set("UV", "transformedUv")) : e.defines.set("UV", "vUv"), e.shaderParts.set(S.FRAGMENT_HEAD, r), e.shaderParts.set(S.FRAGMENT_MAIN_IMAGE, i), e.shaderParts.set(S.FRAGMENT_MAIN_UV, s);
...
#`));
  ...
  render(e, t, r, i, s) {
    ...
    if (!this.skipRendering || this.renderToScreen) {
      const a = this.fullscreenMaterial;
      a.inputBuffer = t.texture, a.time += i * this.timeScale, e.setRenderTarget(this.renderToScreen ? null : r), e.render(this.scene, this.camera);
    }
  }
  /**
   * Updates the size of this pass.
  ...
  initialize(e, t, r) {
    ...
    for (const i of this.effects)
      i.initialize(e, t, r);
    this.updateMaterial(), r !== void 0 && r !== H && (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
  /**
  ...
  constructor({
    ...
    iterations: t = 1,
    resolutionScale: r = 1,
    resolutionX: i = E.AUTO_SIZE,
    resolutionY: s = E.AUTO_SIZE
  } = {}) {
    super("GaussianBlurPass"), this.renderTargetA = new y(1, 1, { depthBuffer: false }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "Blur.Target.B", this.blurMaterial = new Ws({ kernelSize: e }), this.copyMaterial = new _e(), this.copyMaterial.inputBuffer = this.renderTargetB.texture;
    const a = this.resolution = new E(this, i, s, r);
  ...
  render(e, t, r, i, s) {
    ...
    let h = t;
    for (let f = 0, d = Math.max(this.iterations, 1); f < d; ++f)
      u.direction.set(1, 0), u.inputBuffer = h.texture, e.setRenderTarget(o), e.render(a, n), u.direction.set(0, 1), u.inputBuffer = o.texture, e.setRenderTarget(l), e.render(a, n), f === 0 && d > 1 && (h = l);
    this.fullscreenMaterial = this.copyMaterial, e.setRenderTarget(this.renderToScreen ? null : r), e.render(a, n);
  }
  /**
   * Updates the size of this pass.
   *
  ...
  constructor(e, t, {
    ...
    u.overrideClearColor = new K(7829503), u.overrideClearAlpha = 1, this.renderTarget = r, this.renderTarget === void 0 && (this.renderTarget = new y(1, 1, {
      minFilter: _,
      magFilter: _
    }), this.renderTarget.texture.name = "NormalPass.Target");
    const h = this.resolution = new E(this, n, o, i);
...
function Fe(e, t, r, i) {
  const s = r[0] - t[0], a = r[1] - t[1], n = r[2] - t[2], o = e[0] - t[0], l = e[1] - t[1], u = e[2] - t[2], h = a * u - n * l, f = n * o - s * u, d = s * l - a * o, v = Math.sqrt(h * h + f * f + d * d), A = v * 0.5, p = h / v, x = f / v, C = d / v, T = -(e[0] * p + e[1] * x + e[2] * C), D = i[0] * p + i[1] * x + i[2] * C;
  return Math.abs(D + T) * A / 3;
}
function De(e, t, r, i, s, a) {
  const n = (r + i * t + s * t * t) * 4;
  a[0] = e[n + 0], a[1] = e[n + 1], a[2] = e[n + 2];
}
function $s(e, t, r, i, s, a) {
  const n = r * (t - 1), o = i * (t - 1), l = s * (t - 1), u = Math.floor(n), h = Math.floor(o), f = Math.floor(l), d = Math.ceil(n), v = Math.ceil(o), A = Math.ceil(l), p = n - u, x = o - h, C = l - f;
  if (u === n && h === o && f === l)
    De(e, t, n, o, l, a);
  else {
    let T;
    p >= x && x >= C ? T = fe[0] : p >= C && C >= x ? T = fe[1] : C >= p && p >= x ? T = fe[2] : x >= p && p >= C ? T = fe[3] : x >= C && C >= p ? T = fe[4] : C >= x && x >= p && (T = fe[5]);
    const [D, G, Z, j] = T, J = Dt[0];
    J[0] = p, J[1] = x, J[2] = C;
    const P = Dt[1], ce = d - u, ue = v - h, ee = A - f;
    P[0] = ce * D[0] + u, P[1] = ue * D[1] + h, P[2] = ee * D[2] + f, De(e, t, P[0], P[1], P[2], I[0]), P[0] = ce * G[0] + u, P[1] = ue * G[1] + h, P[2] = ee * G[2] + f, De(e, t, P[0], P[1], P[2], I[1]), P[0] = ce * Z[0] + u, P[1] = ue * Z[1] + h, P[2] = ee * Z[2] + f, De(e, t, P[0], P[1], P[2], I[2]), P[0] = ce * j[0] + u, P[1] = ue * j[1] + h, P[2] = ee * j[2] + f, De(e, t, P[0], P[1], P[2], I[3]);
    const ie = Fe(G, Z, j, J) * 6, b = Fe(D, Z, j, J) * 6, ye = Fe(D, G, j, J) * 6, Ve = Fe(D, G, Z, J) * 6;
    I[0][0] *= ie, I[0][1] *= ie, I[0][2] *= ie, I[1][0] *= b, I[1][1] *= b, I[1][2] *= b, I[2][0] *= ye, I[2][1] *= ye, I[2][2] *= ye, I[3][0] *= Ve, I[3][1] *= Ve, I[3][2] *= Ve, a[0] = I[0][0] + I[1][0] + I[2][0] + I[3][0], a[1] = I[0][1] + I[1][1] + I[2][1] + I[3][1], a[2] = I[0][2] + I[1][2] + I[2][2] + I[3][2];
  }
}
var nn = class {
  /**
   ...
   */
  static expand(e, t) {
    const r = Math.cbrt(e.length / 4), i = new Float32Array(3), s = new e.constructor(t ** 3 * 4), a = e instanceof Uint8Array ? 255 : 1, n = t ** 2, o = 1 / (t - 1);
    for (let l = 0; l < t; ++l)
      for (let u = 0; u < t; ++u)
        for (let h = 0; h < t; ++h) {
          const f = h * o, d = u * o, v = l * o, A = Math.round(h + u * t + l * n) * 4;
          $s(e, r, f, d, v, i), s[A + 0] = i[0], s[A + 1] = i[1], s[A + 2] = i[2], s[A + 3] = a;
        }
    return s;
  }
}, ge = [
  new Float32Array(2),
  new Float32Array(2)
], he = 16, je = 20, de = 30, ea = 32, Je = new Float32Array([
  0,
  -0.25,
  0.25,
  -0.125,
...
function Tt(e) {
  const t = ge[0], r = ge[1], i = Math.sqrt(t[0] * 2) * 0.5, s = Math.sqrt(t[1] * 2) * 0.5, a = Math.sqrt(r[0] * 2) * 0.5, n = Math.sqrt(r[1] * 2) * 0.5, o = ra(e / ea);
  t[0] = Oe(i, t[0], o), t[1] = Oe(s, t[1], o), r[0] = Oe(a, r[0], o), r[1] = Oe(n, r[1], o);
}
function L(e, t, r, i, s, a) {
  const n = r - e, o = i - t, l = s, u = s + 1, h = t + o * (l - e) / n, f = t + o * (u - e) / n;
  if (l >= e && l < r || u > e && u <= r)
    if (Math.sign(h) === Math.sign(f) || Math.abs(h) < 1e-4 || Math.abs(f) < 1e-4) {
      const d = (h + f) / 2;
      d < 0 ? (a[0] = Math.abs(d), a[1] = 0) : (a[0] = 0, a[1] = Math.abs(d));
    } else {
      const d = -t * n / o + e, v = Math.trunc(d), A = d > e ? h * (d - v) / 2 : 0, p = d < r ? f * (1 - (d - v)) / 2 : 0;
...
function ia(e, t, r, i, s) {
  const a = ge[0], n = ge[1], o = 0.5 + i, l = 0.5 + i - 1, u = t + r + 1;
  switch (e) {
    case 0: {
      s[0] = 0, s[1] = 0;
      break;
    ...
    case 1: {
      t <= r ? L(0, l, u / 2, 0, t, s) : (s[0] = 0, s[1] = 0);
      break;
    }
    case 2: {
      t >= r ? L(u / 2, 0, u, l, t, s) : (s[0] = 0, s[1] = 0);
      break;
    }
    case 3: {
      L(0, l, u / 2, 0, t, a), L(u / 2, 0, u, l, t, n), Tt(u), s[0] = a[0] + n[0], s[1] = a[1] + n[1];
      break;
    }
    case 4: {
      t <= r ? L(0, o, u / 2, 0, t, s) : (s[0] = 0, s[1] = 0);
      break;
    }
    case 5: {
      s[0] = 0, s[1] = 0;
    ...
    case 6: {
      Math.abs(i) > 0 ? (L(0, o, u, l, t, a), L(0, o, u / 2, 0, t, n), L(u / 2, 0, u, l, t, s), n[0] = n[0] + s[0], n[1] = n[1] + s[1], s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2) : L(0, o, u, l, t, s);
      break;
    }
    case 7: {
      L(0, o, u, l, t, s);
    ...
    case 8: {
      t >= r ? L(u / 2, 0, u, o, t, s) : (s[0] = 0, s[1] = 0);
      break;
    }
    case 9: {
      Math.abs(i) > 0 ? (L(0, l, u, o, t, a), L(0, l, u / 2, 0, t, n), L(u / 2, 0, u, o, t, s), n[0] = n[0] + s[0], n[1] = n[1] + s[1], s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2) : L(0, l, u, o, t, s);
      break;
    }
    case 10: {
      s[0] = 0, s[1] = 0;
    ...
    case 12: {
      L(0, o, u / 2, 0, t, a), L(u / 2, 0, u, o, t, n), Tt(u), s[0] = a[0] + n[0], s[1] = a[1] + n[1];
      break;
    }
    case 13: {
      L(0, l, u, o, t, s);
...
function sa(e, t, r, i, s, a) {
  let n = e === r && t === i;
  if (!n) {
    const o = (e + r) / 2, l = (t + i) / 2, u = i - t, h = e - r;
    n = u * (s - o) + h * (a - l) > 0;
  }
  return n;
}
function Ct(e, t, r, i, s, a) {
  let n = 0;
  for (let o = 0; o < de; ++o)
    for (let l = 0; l < de; ++l) {
      const u = l / (de - 1), h = o / (de - 1);
      sa(e, t, r, i, s + u, a + h) && ++n;
    }
  return n / (de * de);
}
function M(e, t, r, i, s, a, n, o) {
  const l = Qt[e], u = l[0], h = l[1];
  return u > 0 && (t += n[0], r += n[1]), h > 0 && (i += n[0], s += n[1]), o[0] = 1 - Ct(t, r, i, s, 1 + a, 0 + a), o[1] = Ct(t, r, i, s, 1 + a, 1 + a), o;
}
function aa(e, t, r, i, s) {
  const a = ge[0], n = ge[1], o = t + r + 1;
  switch (e) {
    case 0: {
      M(e, 1, 1, 1 + o, 1 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 1: {
      M(e, 1, 0, 0 + o, 0 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 2: {
      M(e, 0, 0, 1 + o, 0 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 3: {
      M(e, 1, 0, 1 + o, 0 + o, t, i, s);
      break;
    }
    case 4: {
      M(e, 1, 1, 0 + o, 0 + o, t, i, a), M(e, 1, 1, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 5: {
      M(e, 1, 1, 0 + o, 0 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 6: {
      M(e, 1, 1, 1 + o, 0 + o, t, i, s);
      break;
    }
    case 7: {
      M(e, 1, 1, 1 + o, 0 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 8: {
      M(e, 0, 0, 1 + o, 1 + o, t, i, a), M(e, 1, 0, 1 + o, 1 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 9: {
      M(e, 1, 0, 1 + o, 1 + o, t, i, s), M(e, 1, 0, 1 + o, 1 + o, t, i, s);
      break;
    }
    case 10: {
      M(e, 0, 0, 1 + o, 1 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 11: {
      M(e, 1, 0, 1 + o, 1 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 12: {
      M(e, 1, 1, 1 + o, 1 + o, t, i, s);
      break;
    }
    case 13: {
      M(e, 1, 1, 1 + o, 1 + o, t, i, a), M(e, 1, 0, 1 + o, 1 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 14: {
      M(e, 1, 1, 1 + o, 1 + o, t, i, a), M(e, 1, 1, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
      break;
    }
    case 15: {
      M(e, 1, 1, 1 + o, 1 + o, t, i, a), M(e, 1, 0, 1 + o, 0 + o, t, i, n), s[0] = (a[0] + n[0]) / 2, s[1] = (a[1] + n[1]) / 2;
...
function St(e, t, r) {
  ...
  for (let s = 0, a = e.length; s < a; ++s) {
    ...
    for (let u = 0; u < l; ++u)
      for (let h = 0; h < l; ++h) {
        r ? ia(s, h, u, t, i) : aa(s, h, u, t, i);
        const f = (u * l + h) * 2;
        o[f] = i[0] * 255, o[f + 1] = i[1] * 255;
      }
  }
}
function Bt(e, t, r, i, s, a, n) {
  const o = n.data, l = n.width;
  for (let u = 0, h = r.length; u < h; ++u) {
    const f = i[u], d = r[u], v = d.data, A = d.width;
    for (let p = 0; p < s; ++p)
      for (let x = 0; x < s; ++x) {
        const C = f[0] * s + e + x, D = ((f[1] * s + t + p) * l + C) * 4, G = a ? (p * p * A + x * x) * 2 : (p * A + x) * 2;
        o[D] = v[G], o[D + 1] = v[G + 1], o[D + 2] = 0, o[D + 3] = 255;
      }
  }
}
var on = class {
   ...
   */
  static generate() {
    const e = 10 * he, t = Je.length * 5 * he, r = new Uint8ClampedArray(e * t * 4), i = new ne(e, t, r), s = Math.pow(he - 1, 2) + 1, a = je, n = [], o = [];
    for (let l = 3, u = r.length; l < u; l += 4)
      r[l] = 255;
    for (let l = 0; l < 16; ++l)
      n.push(new ne(
        s,
...
var ln = class {
  ...
  generate() {
    ...
    return (t[0] !== null && t[1] !== null ? Promise.resolve(t) : oa(e)).then((i) => new Promise((s, a) => {
      const n = new Image(), o = new Image(), l = new le();
      l.onLoad = () => s([n, o]), l.onError = a, n.addEventListener("error", (u) => l.itemError("smaa-search")), o.addEventListener("error", (u) => l.itemError("smaa-area")), n.addEventListener("load", () => l.itemEnd("smaa-search")), o.addEventListener("load", () => l.itemEnd("smaa-area")), l.itemStart("smaa-search"), l.itemStart("smaa-area"), n.src = i[0], o.src = i[1];
    }));
  }
}, Ne = /* @__PURE__ */ new Map([
...
function k(e, t, r, i) {
  const s = qe(e, t, 0.75), a = qe(r, i, 1 - 0.25);
  return qe(s, a, 1 - 0.125);
}
function la(e, t) {
  let r = 0;
  return t[3] === 1 && (r += 1), r === 1 && t[2] === 1 && e[1] !== 1 && e[3] !== 1 && (r += 1), r;
}
function ca(e, t) {
  let r = 0;
  return t[3] === 1 && e[1] !== 1 && e[3] !== 1 && (r += 1), r === 1 && t[2] === 1 && e[0] !== 1 && e[2] !== 1 && (r += 1), r;
}
var cn = class {
  /**
  ...
  static generate() {
    ...
    for (let o = 0; o < 33; ++o)
      for (let l = 0; l < 66; ++l) {
        const u = 0.03125 * l, h = 0.03125 * o;
        if (Ne.has(u) && Ne.has(h)) {
          const f = Ne.get(u), d = Ne.get(h), v = o * 66 + l;
          a[v] = 127 * la(f, d), a[v + 33] = 127 * ca(f, d);
        }
      }
    for (let o = 0, l = 33 - 16; l < 33; ++l)
      for (let u = 0; u < 64; ++u, o += 4)
        n[o] = a[l * 66 + u], n[o + 3] = 255;
    return new ne(64, 16, n);
  }
};
export {
  ma as ASCIIEffect,
  Zr as ASCIITexture,
  Us as AdaptiveLuminanceMaterial,
  Rs as AdaptiveLuminancePass,
  m as BlendFunction,
  Kr as BlendMode,
  ui as BloomEffect,
  Pe as BlurPass,
  Aa as BokehEffect,
  be as BokehMaterial,
  Ns as BoxBlurMaterial,
  $a as BoxBlurPass,
  xa as BrightnessContrastEffect,
  wa as ChromaticAberrationEffect,
  Ei as CircleOfConfusionMaterial,
  cr as ClearMaskPass,
  Ie as ClearPass,
  Ea as ColorAverageEffect,
  ve as ColorChannel,
  Da as ColorDepthEffect,
  ls as ColorEdgesMaterial,
  Nt as ConvolutionMaterial,
  _e as CopyMaterial,
  lt as CopyPass,
  Yi as DepthComparisonMaterial,
  ks as DepthCopyMaterial,
  we as DepthCopyMode,
  Xs as DepthCopyPass,
  xs as DepthDownsamplingMaterial,
  Es as DepthDownsamplingPass,
  Ta as DepthEffect,
  ss as DepthMaskMaterial,
  Ca as DepthOfFieldEffect,
  _t as DepthPass,
  en as DepthPickingPass,
  Xs as DepthSavePass,
  Se as DepthTestStrategy,
  ha as Disposable,
  Sa as DotScreenEffect,
  si as DownsamplingMaterial,
  ls as EdgeDetectionMaterial,
  zt as EdgeDetectionMode,
  B as Effect,
  N as EffectAttribute,
  da as EffectComposer,
  Qs as EffectMaterial,
  tn as EffectPass,
  hr as EffectShaderData,
  S as EffectShaderSection,
  Ba as FXAAEffect,
  Ma as GammaCorrectionEffect,
  dr as GaussKernel,
  Ws as GaussianBlurMaterial,
  rn as GaussianBlurPass,
  Ia as GlitchEffect,
  me as GlitchMode,
  Pa as GodRaysEffect,
  Ri as GodRaysMaterial,
  ya as GridEffect,
  Ua as HueSaturationEffect,
  va as ImmutableTimer,
  ga as Initializable,
  Nt as KawaseBlurMaterial,
  Pe as KawaseBlurPass,
  $ as KernelSize,
  ba as LUT1DEffect,
  La as LUT3DEffect,
  ja as LUT3dlLoader,
  ...
  Hi as LUTOperation,
  sn as LambdaPass,
  Ra as LensDistortionEffect,
  ct as LookupTexture,
  ct as LookupTexture3D,
  ti as LuminanceMaterial,
  Ht as LuminancePass,
  Gt as MaskFunction,
  wi as MaskMaterial,
  fr as MaskPass,
  li as MipmapBlurPass,
  Oa as NoiseEffect,
  it as NoiseTexture,
  an as NormalPass,
  Ki as OutlineEdgesMaterial,
  Na as OutlineEffect,
  Ki as OutlineMaterial,
  vt as OverrideMaterialManager,
  O as Pass,
  Ha as PixelationEffect,
  zi as PredicationMode,
  ne as RawImageData,
  Ga as RealisticBokehEffect,
  Qe as RenderPass,
  pa as Resizable,
  E as Resizer,
  E as Resolution,
  on as SMAAAreaImageData,
  Va as SMAAEffect,
  ln as SMAAImageGenerator,
  qa as SMAAImageLoader,
  Ae as SMAAPreset,
  cn as SMAASearchImageData,
  fs as SMAAWeightsMaterial,
  Ya as SSAOEffect,
  ps as SSAOMaterial,
  lt as SavePass,
  ...
  S as Section,
  Ot as Selection,
  _a as SelectiveBloomEffect,
  Qa as SepiaEffect,
  W as ShaderPass,
  za as ShockWaveEffect,
  nn as TetrahedralUpscaler,
  Wa as TextureEffect,
  Bs as TiltShiftBlurMaterial,
  Ms as TiltShiftBlurPass,
  Xa as TiltShiftEffect,
  or as Timer,
  Ka as ToneMappingEffect,
  V as ToneMappingMode,
  oi as UpsamplingMaterial,
  Za as VignetteEffect,
  xe as VignetteTechnique,
  Fa as WebGLExtension,
  fa as version
};
