...
export class ResourcePackUI {
    constructor(manager, canvas, options = {}) {
        ...
        Object.defineProperty(this, "packList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "draggedPackId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    createToggleSwitch(isOn, onChange) {
    ...
    setupDragEvents(item, packId) {
        ...
        item.addEventListener("drop", async (e) => {
            ...
            if (this.draggedPackId && this.draggedPackId !== packId) {
                ...
                const items = Array.from(this.packList.querySelectorAll(".resource-pack-item"));
