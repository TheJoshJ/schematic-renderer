    ...
    showSessionSummary(sessionData) {
        ...
        summaryEl.innerHTML = `
            ...
            <div style="line-height: 1.4;">
                ...
                <strong>🧱 Blocks:</strong> ${sessionData.chunkProcessingData.reduce((sum, chunk) => sum + chunk.blockCount, 0).toLocaleString()}<br>
                <strong>📐 Vertices:</strong> ${sessionData.chunkProcessingData.reduce((sum, chunk) => sum + chunk.totalVertices, 0).toLocaleString()}<br>
            </div>
        `;
