 ...
 * Export error codes
 */
export type ExportErrorCode = "NO_MESHES" | "INVALID_FORMAT" | "CONVERSION_FAILED" | "DOWNLOAD_FAILED" | "CANCELLED" | "UNKNOWN";
/**
 * Callback types
 */
 ...
 * Export event types
 */
export type ExportEventType = "exportStarted" | "exportProgress" | "exportComplete" | "exportError" | "exportCancelled";
/**
 * Export event map
 */
