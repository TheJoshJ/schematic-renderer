...
export class ChunkRenderingChart {
    constructor(container, theme = "dark") {
        ...
        Object.defineProperty(this, "margin", {
            ...
            configurable: true,
            writable: true,
            value: { top: 40, right: 30, bottom: 120, left: 80 }
        });
    ...
    showPhaseTooltip(event, chunk, phase) {
        const coords = `[${chunk.chunkCoords.join(", ")}]`;
