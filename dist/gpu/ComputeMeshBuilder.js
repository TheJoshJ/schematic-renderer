 ...
 */
import { gpuCapabilityManager } from "./GPUCapabilityManager";
// Workgroup size for compute shaders
const WORKGROUP_SIZE = 64;
export class ComputeMeshBuilder {
    constructor() {
        Object.defineProperty(this, "gpuManager", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "paletteVertexBuffer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "paletteIndicesBuffer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "paletteMetadataBuffer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        // Cached palette info
        Object.defineProperty(this, "paletteData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "bindGroupLayout", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
     ...
     */
    async uploadPaletteData(paletteCache) {
        if (!this.initialized) {
        ...
        // Create GPU buffers
        this.paletteVertexBuffer = this.gpuManager.createStorageBuffer(this.paletteData.vertexData, "palette-vertex-data");
        this.paletteIndicesBuffer = this.gpuManager.createStorageBuffer(this.paletteData.indices, "palette-indices");
        this.paletteMetadataBuffer = this.gpuManager.createStorageBuffer(this.paletteData.metadata, "palette-metadata");
     ...
     */
    buildGPUPaletteData(paletteCache) {
        ...
        for (let i = 0; i < blockData.length; i++) {
            ...
            for (const group of block.materialGroups) {
                ...
                for (let v = 0; v < vCount; v++) {
                    ...
                    // Position
                    vertexData[outBase + 0] = posAttr.array[v * 3 + 0];
                    vertexData[outBase + 1] = posAttr.array[v * 3 + 1];
                    vertexData[outBase + 2] = posAttr.array[v * 3 + 2];
                    // Normal
                    if (normAttr) {
                        vertexData[outBase + 3] = normAttr.array[v * 3 + 0];
                        vertexData[outBase + 4] = normAttr.array[v * 3 + 1];
                        vertexData[outBase + 5] = normAttr.array[v * 3 + 2];
                    }
                    else {
                    ...
                    // UV
                    if (uvAttr) {
                        vertexData[outBase + 6] = uvAttr.array[v * 2 + 0];
                        vertexData[outBase + 7] = uvAttr.array[v * 2 + 1];
                    }
                    else {
     ...
     */
    async buildChunk(blocks, chunkOrigin, _chunkId) {
