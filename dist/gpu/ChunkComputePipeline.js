...
export class ChunkComputePipeline {
    constructor() {
        ...
        Object.defineProperty(this, "paletteUploaded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "pendingBuilds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "buildingChunks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
     ...
     */
    async uploadPalette(paletteCache) {
        if (!this.initialized) {
    ...
    async buildChunk(request) {
        ...
        const gpuResult = await this.computeMeshBuilder.buildChunk(request.blocks, origin, request.chunkId);
     ...
     */
    createMeshesFromResult(result, globalMaterials) {
        const meshes = [];
...
export function getChunkComputePipeline() {
    if (!pipelineInstance) {
        pipelineInstance = new ChunkComputePipeline();
    }
    return pipelineInstance;
}
export function disposeChunkComputePipeline() {
    if (pipelineInstance) {
