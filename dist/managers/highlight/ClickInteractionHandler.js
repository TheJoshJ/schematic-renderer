...
export class ClickInteractionHandler {
    constructor(schematicRenderer) {
        ...
        Object.defineProperty(this, "debugHelpers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "onClick", {
            ...
            value: (event) => {
                ...
                this.raycaster.setFromCamera(this.mouse, this.schematicRenderer.cameraManager.activeCamera.camera);
                ...
                if (intersects.length > 0) {
                    ...
                    if (intersect.face) {
                        ...
                        const fractional = new THREE.Vector3(schematicCoords.x - localPosition.x, schematicCoords.y - localPosition.y, schematicCoords.z - localPosition.z);
                        ...
                        const epsilon = 0.001;
                        if (Math.abs(localFaceNormal.x) > 0.9 &&
                            Math.abs(fractional.x) < epsilon &&
                            localFaceNormal.x > 0) {
                            localPosition.x -= 1;
                        }
                        if (Math.abs(localFaceNormal.y) > 0.9 &&
                            Math.abs(fractional.y) < epsilon &&
                            localFaceNormal.y > 0) {
                            localPosition.y -= 1;
                        }
                        if (Math.abs(localFaceNormal.z) > 0.9 &&
                    ...
                    const schematicDataPosition = new THREE.Vector3(localPosition.x + 1, localPosition.y + 1, localPosition.z + 1);
                    ...
                    const blockCenterLocal = new THREE.Vector3(localPosition.x + 0.5 + 0.5, // block pos + center + render offset
                    ...
                    const highlightBox = new THREE.Mesh(new THREE.BoxGeometry(1.01, 1.01, 1.01), // Slightly larger for outline effect
