...
export class AnnotationHighlight {
    constructor(schematicRenderer) {
        ...
        Object.defineProperty(this, "annotationInput", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        // @ts-ignore
        Object.defineProperty(this, "hoverPosition", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "onAddAnnotation", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (position) => {
    ...
    `;
        ...
        const inputField = this.annotationInput.querySelector("#annotation-text");
    ...
    showAnnotationInput(position) {
        ...
        this.annotationInput.querySelector("#annotation-text").focus();
        this.annotationInput.dataset.position = JSON.stringify(position.toArray());
    }
    hideAnnotationInput() {
        this.annotationInput.style.display = "none";
        this.annotationInput.querySelector("#annotation-text").value = "";
    }
    submitAnnotation() {
        const text = this.annotationInput.querySelector("#annotation-text").value;
    ...
    addAnnotation(position, text, color = 0x00aaff) {
        ...
        for (const key in this.annotations) {
            ...
            if (annotation && annotation.label && annotation.label.position) {
                ...
                if (annotation.label.material) {
                    annotation.label.material.opacity = opacity;
                }
                if (annotation.mesh && annotation.mesh.material && "opacity" in annotation.mesh.material) {
                    annotation.mesh.material.opacity = opacity * 0.3;
                }
            }
        }
    }
