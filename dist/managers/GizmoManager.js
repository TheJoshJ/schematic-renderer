...
export class GizmoManager {
    constructor(schematicRenderer) {
        ...
        Object.defineProperty(this, "boundingBoxHelper", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        this.transformControls = new TransformControls(this.schematicRenderer.cameraManager.activeCamera.camera, this.schematicRenderer.renderManager?.renderer.domElement);
        // Ensure it's on top of everything
        this.transformControls.depthTest = false;
        this.transformControls.depthWrite = false;
    ...
    onObjectSelected(object) {
        ...
        else if (object.group instanceof THREE.Object3D) {
        ...
        if (threeObject) {
            ...
            if ((object.group && object.id.startsWith("region_")) ||
                (object.name && object.name.startsWith("region_"))) {
